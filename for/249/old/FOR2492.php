...
<div style="width: 100%;  margin:0 auto;">
  <form enctype="multipart/form-data" action="" method="post" name="formulario" id="formulario" onsubmit="return validar(this);">
	...
	<div style="text-align:justify">
        Venho por meio deste, comunicar que a partir de <input name="data" maxlength="10" type="text" id="data" size="15" onkeypress="formatar(this, '##/##/####')" onblur="check_date(this.value)"/>
          , será encerrado  as atividades de <input readonly name="servico" type="text" id="servico" size="35" value="<?php if ($linha['campo19'] == "Outra: "){$campo192 = $linha['outraatv'];}else{$campo192 = $linha['campo19'];}; echo $campo192 ?>"/>
          da empresa <input readonly name="empresa" type="text" id="empresa" size="34" value="<?php echo $linha['empresa'] ?>"/>
          com o cliente <input readonly name="cliente" type="text" id="cliente" size="44" value="<?php echo $linha['campo4'] ?>"/>
          , CNPJ <input readonly value="<?php echo $linha['campo8'] ?>"   name="cnpj" type="text" id="cnpj" size="20" />
          , CEI <input readonly value="<?php echo $linha['cei'] ?>"   name="cei" type="text" id="cei" size="20" />
          , código <input   name="codigo" type="text" id="codigo" size="25" value="<?php echo $linha['campo2'] ?>"/>
          , cidade <input readonly   name="cidade" type="text" id="cidade" size="20" value="<?php echo $linha['campo6'] ?>"/>.
	
        <br />
        <br />
        
        Quantidade funcionarios:<br>
<input   name="funcionarios" type="text" id="funcionarios" size="5" /><br /><br>
        ...
        <label for="radio2">NÃO</label><br>
        Obs.: <input   name="obs" type="text" id="obs" size="51" /><br /><br>
        ...
        <br />
        Quais? <input   name="quais" type="text" id="quais" size="88" /><br /><br>
		...
		<br /><br />
        Motivo do encerramento: <input   name="mensagem" type="text" id="mensagem" size="70" />
      </div>
      <br />
...
<input class="btn btn-info"  type="submit" name="submit" id="submit" value="Gerar PDF"/><br>
