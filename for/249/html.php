          ...
          <tbody>
            ...
            <tr>
              <td><table align="center" border="0" cellpadding="0" cellspacing="0" width="628">
                  <tbody>
                    <tr>
                      <td style="color: #d9534f; font-size: 16px; font-family: Helvetica, Arial, sans-serif;"> FOR 249 - Comunicado de Cancelamento e Encerramento de Serviços</td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                    </tr>
                    <tr>
                      <td style="color: #666666; font-size: 12px;  font-family: Helvetica, Arial, sans-serif;"> Olá<br>
                        <br>
                        Esse e-mail confirma o envio do FOR 249 referente ao encerramento do serviço de <b><?php echo $post->servico; ?></b> do cliente <b><?php echo $post->cliente; ?></b>, verifique o PDF em anexo!<br>
                        <br>
                        Att.<br>
