...
<form enctype="multipart/form-data" method="POST" name="formulario" id="formulario" action="alterar_dp2.php" target="" onsubmit="">
...
<input class="btn btn-info" type="submit" name="submit" id="submit"  value="Salvar"> <input type="button" class="btn btn-danger" value="Voltar" onclick="window.location.href = 'FOR1682.php'"/>
</div>
