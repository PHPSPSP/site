...
$to = "$nome <$emusuario>";
$assunto = utf8_encode("FOR 168 - Cadastro de Clientes - $campo4");
$datee = date("Y");
...
<td colspan="2" style="color: #d9534f; font-size: 16px; font-family: Helvetica, Arial, sans-serif;"> FOR 168 - Cadastro de Clientes</td></tr><tr><td height="20" colspan="2"></td></tr><tr>
</tr>
<tr>
  <td colspan="2" style="color: #666666; font-size: 12px;  font-family: Helvetica, Arial, sans-serif;">Olá<br>
    <br>
Venho através deste informar o Cadastro do Cliente: <b> '. $campo4 .' </b> :<br />
<br />
...
<td align="right" style="color: #fefefe; font-size: 11px; font-family: Helvetica, Verdana, sans-serif; padding: 15px 0;"> SPSP &copy; '. $datee .' . Todos os direitos reservados. </td></tr></tbody></table>
		...
		$headers .= "Cc: \"Vanessa Lima\" <vanessa.lima@spsp.com.br>, \"Daniel Barros\" <silvia.fiamengui@spsp.com.br>, \"Ana Peraira\" <ana.pereira@spsp.com.br>, \"Dayse Rocha\" <dayse.rocha@spsp.com.br>, \"Camila Sotelo\" <camila.sotelo@spsp.com.br>, \"Claudia Franzen\" <claudia.franzen@spsp.com.br>, \"Fabiana Tomasela\" <fabiana.tomasela@spsp.com.br>, \"Deise Lourenco\" <deise.lourenco@spsp.com.br>\n";
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
	window.alert('Cadastro de Cliente Realizado com Sucesso!');</SCRIPT>");
		
    $sql_UP = "INSERT for054fim SET 
