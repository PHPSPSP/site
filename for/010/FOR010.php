    ...
    <section id="two" class="section swatch-white">
      <div class="container">
        ...
        <form enctype="multipart/form-data" action="envia.php" method="post" name="formulario" id="formulario" onsubmit="return validar(this);">
          <div class="row ">
            <div class="col-md-4 col-sm-4 col-xs-12 text-left small-screen-center" name="clientelista" id="clientelista"> Cliente:
...
/*if ($id == 150 || $id == 103 || $id == 106 || $id == 125 || $id == 126 || $id == 1) {
	$consulta=mysql_query("SELECT CODCLI, NOMECLI FROM sarclien WHERE DTENCERRA IS NULL ORDER BY NOMECLI ASC");} else {
...
<style type="text/css">.interroga{background-color: red !important; padding-left: 10; padding-right: 10; color: white; margin-right: 15;};</style>

<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(1);"><span class="interroga"> ?</span>Rotina</div>
 ...
 <div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(2);"><span class="interroga"> ?</span>Postura</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(3);"><span class="interroga"> ?</span>Uniforme</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(4);"><span class="interroga"> ?</span>Cartão de Ponto</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(5);"><span class="interroga"> ?</span>Pasta Rotina/Manual/FOR</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(6);"><span class="interroga"> ?</span>Contato com o Cliente</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
                        <label class="btn btn-success col-md-6 col-sm-6 col-xs-6" for="cliente_conf">
                          ...
                          Sim</label>
                        <label class="btn btn-warning col-md-6 col-sm-6 col-xs-6" for="cliente_naplica">
                          <input name="cliente" id="cliente_naplica" type="radio" required value="naplica" ondblclick="limparRadios('cliente');" >
                          Não Aplica</label>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center "  >
              <div class="form-group form-icon-group">
                <div class="row">
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(7);"><span class="interroga"> ?</span>Livro de Ocorrência</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(8);"><span class="interroga"> ?</span>Produtos Equipamentos</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(9);"><span class="interroga"> ?</span>EPI</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(10);"><span class="interroga"> ?</span>Estoque Prod. Equipam.</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
<div class="btn col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left: 15px !important; background-color: #e9e9e9;color: grey;text-align: left !important;" onclick="mostrar(11);"><span class="interroga"> ?</span>Outros</div>
                  <div class="col-md-6 col-sm-6 col-xs-12 text-center small-screen-center" style="margin-left:-15px !important">
                    <div class="row">
                      <div class="btn-group col-md-12 col-sm-12 col-xs-12" data-toggle="buttons">
...
if(formulario.nomeposto.value == 'Selecione...'){alert("Informe o NOME do CLIENTE."); return false;}
    ...
    function buscar_postos(){
      ...
      if(nomeposto){
        ...
        function carregacli() {
        var url = 'FOR010-cli.php';
        $.get(url, function(dataReturn) {
          $('#clientelista').html(dataReturn);
        });
        }
        window.onload = carregacli;
