        ...
        <div class="row">
          <div class="col-md-12">
            <header class="text-center element-normal-top element-medium-bottom not-condensed "  >
              ...
              <h1 class="super hairline bordered bordered-normal">Implantação de Serviços Extras (temporário)</h1>
...
?>
                  ...
                  <br />
                  Supervisor:<br />
                  <select required="required" class="form-control"  name="supervisor" id="supervisor">
...
?>
                  ...
                  Serviço Extra:<br />
                  <input type="radio" name="tipoextra" value="Inicio" id="radioserex1" />
                    <label for="radioserex1">Início</label>
                  <input type="radio" name="tipoextra" value="Aumento" id="radioserex2" />
                    <label for="radioserex2">Aumento</label>
                </div>
                <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Empresa:<br />
                  ...
                  <br />
                  Filial:<br />
                  <select required="required" class="form-control"  name="regiao" id="regiao">
