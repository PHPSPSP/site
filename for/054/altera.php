...
if ($linha['nomeuser'] = ""){	  echo ("<SCRIPT LANGUAGE='JavaScript'>
        window.alert('Ocorreu um erro na listagem do FOR, entre em contato com o Departamento de Marketing.');
		window.location.href='FOR054.php';
        </SCRIPT>");}else{	};
            ...
            <div >
              <div style="width: 100%;  margin:0 auto;"><br />
                <div style="width:48%; float:left"> Tipo de Implantação:<br />
                  <input id="radio1" name="cabecalho" value="Implantacao Inicial" checked="" type="radio" <?php echo $linha['cabecalho'] == 'Implantacao Inicial' ? "checked" : ""?>>
                  <label for="radio1">Implantação</label>
                  <input id="radio2" name="cabecalho" value="Ampliacao" type="radio" <?php echo $linha['cabecalho'] == 'Ampliacao' ? "checked" : ""?>>
                  <label for="radio2">Ampliação</label>
                  <input id="radio2i" name="cabecalho" value="Reducao" type="radio" <?php echo $linha['cabecalho'] == 'Reducao' ? "checked" : ""?>>
                ...
                <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Código do Cliente:<br />
                  <input name="campo2" type="text" id="campo2" size="30" value="<?php echo $linha['campo2'] ?>"/>
                  <br />
                </div>
...
R$ <input type="text" name="salario1" id="salario1" size="8" required="required" maxlength="8" value="<?php echo $linha['salario1'] ?>" />
...
R$ <input name="salario2" type="text" id="salario2" size="8" maxlength="8" value="<?php echo $linha['salario2'] ?>"/>
...
R$ <input name="salario3" type="text" id="salario3" size="8" maxlength="8" value="<?php echo $linha['salario3'] ?>"/>
...
<!--</div>--></div>
              ...
              <div style="width: 100%; margin:0 auto;"><br />
                ...
                <div style="width:61%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Faturamento:<br />
                  ...
                  <select class="form-control"  name="regcon" id="regcon">
                    <option selected="selected" value="<?php echo $linha['regcon'] ?>"><?php echo $linha['regcon'] ?></option>
                    <option value=""> Selecione...</option>
                ...
                <div id="monitport" style="display:none">
                  <div style="width:35%; float:left"> <strong>Taxa de adesão:</strong><br />
                    <input name="taxaadesao" type="text" id="taxaadesao" size="20" value="<?php echo $linha['taxaadesao'] ?>"/>
                  </div>
                  <div style="width:61%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> <strong>Valor da mensalidade:</strong><br />
                    <input name="mensalvalor" type="text" id="mensalvalor" size="20" value="<?php echo $linha['mensalvalor'] ?>"/>
                  </div>
                  <div style="clear:both"><br />
                  </div>
                </div>
            ...
            <div style="width: 100%; margin:0 auto;">
              ...
              <button type="button" name="send" id="send" value="Salvar" onclick="salvar();" class="btn btn-success"> Salvar </button>
...
function salvar(){
	document.formulario.action = "alterar_db.php?id=<?php echo $_GET['id'] ?>";
	document.formulario.target = "";
/*	document.formulario.submit();*/}	
