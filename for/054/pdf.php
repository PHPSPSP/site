        ...
        <tr>
          <td style="color: #666666;f0ad4e  font-family: Helvetica, Arial, sans-serif;"><table width='100%'>
            ...
            <table  width='100%'>
              <tr>
                <td width="20%">CNPJ *:</td>
                <td width="30%" bgcolor="#F3F3F3"><strong><? echo "$campo8"; ?></strong></td>
                <td width="20%">I.Est.:</td>
                <td width="30%" bgcolor="#F3F3F3"><strong><? echo "$campo9"; ?></strong></td>
              </tr>
              <tr>
                <td width="20%">I.Mun.: </td>
                <td width="30%" bgcolor="#F3F3F3"><strong><? echo "$campo10"; ?></strong></td>
                <td width="20%">CEI: </td>
                <td width="30%" bgcolor="#F3F3F3"><strong><? echo "$cei"; ?></strong></td>
              </tr>
            </table>
            <br />
            <br />
            ...
            <table width="100%">
              ...
              <tr>
                ...
                <td bgcolor="#F3F3F3"><? echo "$salario1"; ?></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#F3F3F3"><? echo "$salario2"; ?></td>
              </tr>
              <tr>
                ...
                <td bgcolor="#F3F3F3"><? echo "$salario3"; ?></td>
              </tr>
              <tr>
