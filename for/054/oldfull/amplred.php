            ...
            <div >
              <div style="width: 100%;  margin:0 auto;"><br />
                <div style="width:48%; float:left"> Tipo de Implantação:<br />
                  <input id="radio1" name="cabecalho" value="Implantacao Inicial" checked="" type="radio" <?php echo $cabecalho == 'Implantacao Inicial' ? "checked" : ""?>>
                  <label for="radio1">Implantação</label>
                  <input id="radio2" name="cabecalho" value="Ampliacao" type="radio" <?php echo $cabecalho == 'Ampliacao' ? "checked" : ""?>>
                  <label for="radio2">Ampliação</label>
                  <input id="radio2i" name="cabecalho" value="Reducao" type="radio" <?php echo $cabecalho == 'Reducao' ? "checked" : ""?>>
              ...
              <div style="width: 100%; margin:0 auto;"><br />
                ...
                <div style="width:61%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Faturamento:<br />
                  ...
                  <select class="form-control"  name="regcon" id="regcon">
                    <option selected="selected" value="<?php echo $linha['regcon'] ?> "><?php echo $mostra; ?> </option>
                    <option value=""> Selecione...</option>
