            ...
            <div >
              <div style="width: 100%;  margin:0 auto;"><br />
                <div style="width:48%; float:left"> Tipo de Implantação:<br />
                  <input id="radio1" name="cabecalho" value="Implantacao Inicial" checked="" type="radio">
                  <label for="radio1">Implantação</label>
                  <input id="radio2" name="cabecalho" value="Ampliacao" type="radio">
                  <label for="radio2">Ampliação</label>
                  <input id="radio2i" name="cabecalho" value="Reducao" type="radio">
                ...
                <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Código do Cliente:<br />
                  <input name="campo2" type="text" id="campo2" size="30" />
                  <br />
                </div>
                ...
                <div style="width:48%; float:left"> Gestor Responsável pela Implantação:<br />
                  <select class="form-control" name="gestor" id="gestor">
                    ...
                    <?php $consulta=mysql_query("SELECT * FROM usuarios where tipo='scom' order by nome ASC "); 
...
echo("<option value='".$dados['nome']."'>".$dados['nome']."</option>");} ?>
                  ...
                  <select class="form-control" name="campo48" id="campo48">
                    <option value="">Selecione...</option>
                    <?php $consulta=mysql_query("SELECT * FROM usuarios where tipo='scom' or tipo='sup' order by nome ASC "); 
while ($dados = mysql_fetch_array($consulta)) {
echo("<option value='".$dados['nome']."'>".$dados['nome']."</option>");} ?>
                  </select>
                </div>
            ...
            <div >
              <div style="width: 100%;  margin:0 auto;"><br />
                ...
                <textarea name="campo4" cols="100" rows="2"  id="campo4" ></textarea>
                <br />
                <br />
                <div style="width:48%; float:left"> Rua e Bairro *:<br />
                  <textarea cols="45" rows="1"  id="campo5" name="campo5"></textarea>
                  <br />
                  <br />
                  Cidade *:<br />
                  <textarea cols="45" rows="1"  id="campo6" name="campo6"></textarea>
                  <br />
                  <br />
                  Fone/Fax: <br />
                  <input name="campo11" type="text" id="campo11" size="40" />
                  <br />
                  <br />
<span>
<div style="float: left;">
CEP: <br />
<input name="campo7" maxlength="10" type="text" id="campo7" size="15" onkeypress="formatar(this, '##.###-###'); return SomenteNumero(event)"/>
</div>
<div style="float: right;">
Página Web: <br />
<input name="campo12" type="text" id="campo12" size="40" />
</div>
</span>
                </div>
                <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> CNPJ *: <br />
                  <input name="campo8" type="text" id="campo8" size="40" maxlength="18" onkeypress="formatar(this, '##.###.###/####-##'); return SomenteNumero(event)" />
                  <br />
                  <br />
                  I. Est.: <br />
                  <input name="campo9" type="text" id="campo9" size="40" />
                  <br />
                  <br />
                  I. Mun.: <br />
                  <input name="campo10" type="text" id="campo10" size="40" />
                  <br />
                  <br />
                  CEI:<br />
                  <input name="cei" type="text" id="cei" style="overflow:hidden;" size="40" />
                </div>
              </div>
            </div>
            <div style="clear:both"></div>
            ...
            <div >
              <div style="width: 100%; margin:0 auto;"><br />
                ...
                <textarea name="campo14" cols="100" rows="1" id="campo14" ></textarea>
                <br />
                <br />
                E-mail para cobrança e envio de documentos:<br />
                <input name="campo13" type="text" id="campo13" size="65" />
                <br />
                <br />
                <div style="width:48%; float:left"> Contato Comercial/Faturamento:<br />
                  <textarea name="campo15" cols="45" rows="1" id="campo15" ></textarea>
                  <br />
                  E-mail:<br />
                  <textarea name="campo16" cols="32" rows="1" id="campo16" ></textarea>
                  <br />
                </div>
                <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Responsável Legal **:<br />
                  <textarea name="campo17" cols="45" rows="1" id="campo17" ></textarea>
                  <br />
                  CPF:<br />
                  <textarea name="campo18" cols="25" rows="1" id="campo18" ></textarea>
                </div>
                <br />
                <div style="clear:both"></div>
                <br />
                Gestor do Contrato:<br />
                <input name="respleg" type="text" id="respleg" size="65"/>
                <div style="clear:both"></div>
                <br />
              </div>
            </div>
              ...
              <div style="width: 100%; margin:0 auto;"><br />
                <div style="width:48%; float:left"> Atividade ***:<br />
                  ...
                  <div style="display:none" id="oculta">Informe a Atividade:<br />
                    <input name="outraatv" type="text" id="outraatv"  size="25" />
                  </div>
                </div>
                <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Data de Início:<br />
                  <input name="campo24" type="text" id="campo24"  onblur="check_date(this.value)" onkeypress="formatar(this, '##/##/####'); return SomenteNumero(event)" size="15" maxlength="10" />
                </div>
                <div style="clear:both"></div>
                <br />
              </div>
              ...
              <div >
                <div style="width: 100%; margin:0 auto;"><br />
                  <div style="width:18%; float:left"> Postos:<br />
                    <input name="campo20" type="text" id="campo20"   size="3" />
                  </div>
                  <div style="width:78%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;">H/mês:<br />
                    <input name="campo22" type="text" id="campo22"   size="10" />
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  <hr style="color:#FFF" />
                  ...
                  <div style="width:40%; float:left"> <strong>Escala da Equipe 01:</strong><br />
                    ...
                    <input name="campo21" type="text" id="campo21"  size="3" />
                    <br />
                    <div style="width:46%; float:left;"> Escala:<br />
                      ...
                      <div id="oculta1" style="display:none;"> Especifique a escala:<br />
                        <input  name="especif1" type="text" id="especif1" size="40" />
                      </div>
                      <div id="oculta2" style="display: none;"> Dias:<br />
                        <input  name="dias241" type="text" id="dias241" size="40" />
                      </div>
                    ...
                    <div style="width:46%; float:right;">
                      <input name="trabsab" id="trabsab" type="checkbox" value=" - Trabalha no Feriado" />
                  ...
                  <div style="width:56%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;">
                    <div style="width:30%; float:left;"><br />
                      <br />
                      Horário:<br />
                      <input name="hora1" maxlength="5" type="text" id="hora1" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input name="hora2" maxlength="5" type="text" id="hora2" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                    </div>
                    <div id="artg71" style="display:block; width:30%; float:left; padding-left:15px;"><br />
                      <br />
                      Intervalo:<br />
                      <input  name="hora3" maxlength="5" type="text" id="hora3" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input  name="hora4" maxlength="5" type="text" id="hora4" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                    </div>
                    <div id="oculta4" style="display:none; width:30%; float:left; padding-left:15px;"><br />
                      <br />
                      Horário sábado:<br />
                      <input  name="horas1" type="text" id="horas1" size="3" maxlength="5" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input  name="horas2" type="text" id="horas2" size="3" maxlength="5" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      <br />
                      <input hidden="hidden" name="txtsab" type="text" id="txtsab" size="10">
                    </div>
                    <br />
                    <div style="clear:both"></div>
                    <br />
                    <div style="float:left;width: 100px;">
                      <input name="art71" id="art71" type="checkbox" value=" - Artigo 71" onclick="val71();"/>
                      <label for="art71">Artigo 71 </label>
                    </div>
                    <div id="artg712" style="display:none; float:left"> =
                      <input type="checkbox" name="art71d" value="Diurno" id="art71d" />
                      <label for="art71d">Diurno</label>
                      <input type="checkbox" name="art71n" value="Noturno" id="art71n" />
...
Salário:<br />
<!--<input type="radio" name="salario" value="Piso da Categoria" id="valorn" onclick="val11();"/>
<label for="valorn">Piso da Categoria</label>&nbsp;&nbsp;
<input type="radio" name="salario" value="Valor Diferenciado" id="valoru" onclick="val11();"/>
...
R$ <input type="text" name="salario1" id="salario1" size="8" required="required" maxlength="8"/>
<script type="text/javascript">$("#salario1").maskMoney();</script>
...
<!--</div>-->
                  ...
                  <div style="width:40%; float:left"> <strong>Escala da Equipe 02:</strong><br />
                    <br />
                    Nº de Colaboradores:<br />
                    <input name="campo212" type="text" id="campo212"  size="3" />
                    <br />
                    <div style="width:46%; float:left;"> Escala:<br />
                      ...
                      <div id="oculta12" style="display:none;"> Especifique a escala:<br />
                        <input  name="especif2" type="text" id="especif2" size="40" />
                      </div>
                      <div id="oculta22" style="display: none;"> Dias:<br />
                        <input  name="dias242" type="text" id="dias242" size="40" />
                      </div>
                    ...
                    <br />
                    <div style="width:46%; float:right;">
                      <input name="trabsab2" id="trabsab2" type="checkbox" value=" - Trabalha no Feriado" />
                  ...
                  <div style="width:56%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;">
                    <div style="width:30%; float:left;"><br />
                      <br />
                      Horário:<br />
                      <input name="hora5" maxlength="5" type="text" id="hora5" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input name="hora6" maxlength="5" type="text" id="hora6" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                    </div>
                    <div id="artg71p2" style="display:block; width:30%; float:left; padding-left:15px;"><br />
                      <br />
                      Intervalo:<br />
                      <input  name="hora7" maxlength="5" type="text" id="hora7" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input  name="hora8" maxlength="5" type="text" id="hora8" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                    </div>
                    <div id="oculta42" style="display:none; width:30%; float:left; padding-left:15px;"><br />
                      <br />
                      Horário sábado:<br />
                      <input  name="horas3" type="text" id="horas3" size="3" maxlength="5" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input  name="horas4" type="text" id="horas4" size="3" maxlength="5" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      <br />
                      <input hidden="hidden" name="txtsab2" type="text" id="txtsab2" size="10">
                    </div>
                    <br />
                    <div style="clear:both"></div>
                    <br />
                    <div style="float:left;width: 100px;">
                      <input name="art71p2" id="art71p2" type="checkbox" value=" - Artigo 71" onclick="val712();"/>
                      <label for="art71p2">Artigo 71 </label>
                    </div>
                    <div id="artg712-2" style="display:none; float:left"> =
                      <input type="checkbox" name="art71dp2" value="Diurno" id="art71dp2" />
                      <label for="art71dp2">Diurno</label>
                      <input type="checkbox" name="art71np2" value="Noturno" id="art71np2" />
                      <label for="art71np2">Noturno</label>
                      <br />
                    </div><div style="clear:both"></div>
                    <div style="float:left;">  <br />
                    Salário:<br />            
<!--<input type="radio" name="salario22" value="Piso da Categoria" id="valorn2" onclick="val211();"/>
<label for="valorn2">Piso da Categoria</label>&nbsp;&nbsp;
<input type="radio" name="salario22" value="Valor Diferenciado" id="valoru2" onclick="val211();"/>
<label for="valoru2">Valor Diferenciado</label>
<div style="display:none;float:right;" id="salariouni2">&nbsp;-->
R$ <input name="salario2" type="text" id="salario2" size="8" maxlength="8" />
<script type="text/javascript">$("#salario2").maskMoney();</script>
<script type="text/javascript">SyntaxHighlighter.all()</script>
<!--</div>--></div>
                  ...
                  <div style="width:40%; float:left"> <strong>Escala da Equipe 03:</strong><br />
                    <br />
                    Nº de Colaboradores:<br />
                    <input name="campo213" type="text" id="campo213"  size="3" />
                    <br />
                    <div style="width:46%; float:left;"> Escala:<br />
                      ...
                      <div id="oculta13" style="display:none;"> Especifique a escala:<br />
                        <input  name="especif3" type="text" id="especif3" size="40" />
                      </div>
                      <div id="oculta23" style="display: none;"> Dias:<br />
                        <input  name="dias243" type="text" id="dias243" size="40" />
                      </div>
                    ...
                    <br />
                    <div style="width:46%; float:right;">
                      <input name="trabsab3" id="trabsab3" type="checkbox" value=" - Trabalha no Feriado" />
                  ...
                  <div style="width:56%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;">
                    <div style="width:30%; float:left;"><br />
                      <br />
                      Horário:<br />
                      <input name="hora9" maxlength="5" type="text" id="hora9" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input name="hora10" maxlength="5" type="text" id="hora10" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                    </div>
                    <div id="artg71p3" style="display:block; width:30%; float:left; padding-left:15px;"><br />
                      <br />
                      Intervalo:<br />
                      <input  name="hora11" maxlength="5" type="text" id="hora11" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input  name="hora12" maxlength="5" type="text" id="hora12" size="3" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                    </div>
                    <div id="oculta43" style="display:none; width:30%; float:left; padding-left:15px;"><br />
                      <br />
                      Horário sábado:<br />
                      <input  name="horas5" type="text" id="horas5" size="3" maxlength="5" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      as
                      <input  name="horas6" type="text" id="horas6" size="3" maxlength="5" onkeypress="formatar(this, '##:##'); return SomenteNumero(event)"/>
                      <br />
                      <input hidden="hidden" name="txtsab3" type="text" id="txtsab3" size="10">
                    </div>
                    <br />
                    <div style="clear:both"></div>
                    <br />
                    <div style="float:left;width: 100px;">
                      <input name="art71p3" id="art71p3" type="checkbox" value=" - Artigo 71" onclick="val713();"/>
                      <label for="art71p3">Artigo 71 </label>
                    </div>
                    <div id="artg712-3" style="display:none; float:left"> =
                      <input type="checkbox" name="art71dp3" value="Diurno" id="art71dp3" />
                      <label for="art71dp3">Diurno</label>
                      <input type="checkbox" name="art71np3" value="Noturno" id="art71np3" />
                      <label for="art71np3">Noturno</label>
                      <br />
                    </div><div style="clear:both"></div>
                    <div style="float:left;"><br />
                    Salário:<br />              
<!--<input type="radio" name="salario33" value="Piso da Categoria" id="valorn3" onclick="val311();"/>
<label for="valorn3">Piso da Categoria</label>&nbsp;&nbsp;
<input type="radio" name="salario33" value="Valor Diferenciado" id="valoru3" onclick="val311();"/>
<label for="valoru3">Valor Diferenciado</label>
<div style="display:none;float:right;" id="salariouni3">&nbsp;-->
R$ <input name="salario3" type="text" id="salario3" size="8" maxlength="8" />
<script type="text/javascript">$("#salario3").maskMoney();</script>
<script type="text/javascript">SyntaxHighlighter.all()</script>
<!--</div>--></div>
                  ...
                  <textarea name="obsesc" cols="100" rows="2" style="overflow:hidden; font-family:Tahoma, Geneva, sans-serif;" id="obsesc" ></textarea>
                  <br />
                  <br />
                  <div style="clear:both"></div>
            ...
            <div >
              <div style="width: 100%; margin:0 auto;"><br />
                <div style="width:35%; float:left"> Vencimento da Fatura:<br />
                  <input name="campo25" type="text" id="campo25" size="5" />
                  <br />
                  <br />
                  Duração do Contrato:<br />
                  <input name="campo26" type="text" id="campo26" size="15" />
                  <br />
                </div>
                <div style="width:61%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Faturamento:<br />
                  <div style="float:left; min-width:110px">
                    <input type="radio" name="fatura" value="Valor Mensal" id="radio3" />
                    <label for="radio3">Valor Mensal</label>
                  </div>
                  <div id="esconde3" style="display:block; ">
                    <input type="radio" name="fatura" value="Valor homem / hora" id="radio4" />
                    <label for="radio4">Valor homem / hora</label>
                  </div>
                  <br />
                  <br />
                  Reajuste do Contrato pelo Índice:<br />
                  <select class="form-control" name="regcon" id="regcon">
                    <option selected="selected" value=""> Selecione...</option>
                    <?php echo $lista_reajuste; ?>
                  </select>
                </div>
              ...
              <div >
                <div style="width: 100%; margin:0 auto;">
                  <div style="float:left; width:37%;"> Súmula 444:<br />
                    ...
                    <input type="radio" name="sumula" value="NAO" id="sumulan" onclick="vals();"/>
                    <label for="sumulan">NÃO</label>
                    <input type="radio" name="sumula" value="SIM" id="sumulas" onclick="vals();"/>
                    <label for="sumulas">SIM</label>
                  </div>
                  <div style="display:none;float:left; width:59%;" id="sumulasim"><br />
                    Será cobrado do cliente?
                    <input type="radio" name="cobrasumula" value="NAO" id="csumulan" />
                    <label for="csumulan">NÃO</label>
                    <input type="radio" name="cobrasumula" value="SIM" id="csumulas" />
                  ...
                  <div style="width:48%; float:left"> <strong>Locação de equipamento:</strong><br />
                    <input type="radio" name="locaequip" value="SIM" id="radio5" />
                    <label for="radio5">SIM</label>
                    <input type="radio" name="locaequip" value="NAO" id="radio6" />
                    <label for="radio6">NÃO</label>
                    <br />
                    <br />
                    Descreva:<br />
                    <textarea name="campo27" cols="45" rows="2" id="campo27"  ></textarea>
                    <br />
                  </div>
                  <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Valor incluso no custo:<br />
                    <input type="radio" name="locaequipv" value="SIM" id="radiolv13" />
                    <label for="radiolv13">SIM</label>
                    <input type="radio" name="locaequipv" value="NAO" id="radiolv14" />
                    <label for="radiolv14">NÃO</label>
                    <br />
                    <br />
                    Valor R$:<br />
                    <input name="campol31" type="text" id="campol31" size="15" />
                    <br />
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  ...
                  <div style="width:48%; float:left"> <strong>Material de consumo:</strong><br />
                    <input type="radio" name="matconsumo" value="SIM" id="radio7" />
                    <label for="radio7">SIM</label>
                    <input type="radio" name="matconsumo" value="NAO" id="radio8" />
                    <label for="radio8">NÃO</label>
                    <br />
                    <br />
                    Descreva:<br />
                    <textarea name="campo28" cols="45" rows="2" id="campo28"  ></textarea>
                    <br />
                  </div>
                  <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Valor incluso no custo:<br />
                    <input type="radio" name="matconsv" value="SIM" id="radiomv13" />
                    <label for="radiomv13">SIM</label>
                    <input type="radio" name="matconsv" value="NAO" id="radiomv14" />
                    <label for="radiomv14">NÃO</label>
                    <br />
                    <br />
                    Valor R$:<br />
                    <input name="campom31" type="text" id="campom31" size="15" />
                    <br />
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  ...
                  <div style="width:48%; float:left"><strong>Uniforme:</strong><br />
                    <input type="radio" name="uniforme" value="Estilo Social - R$ " id="radio11" onclick="val6();"/>
                    <label for="radio11">Estilo Social</label>
                    R$
                    <input name="campo29" type="text" id="campo29" size="5" />
                    <br />
                    <input type="radio" name="uniforme" value="Padrao" id="radio10" onclick="val1();val5();"/>
                    <label for="radio10">Padrão</label>
                    <br />
                    <input type="radio" name="uniforme" value="Especifico - Obs.: " id="radio9" onclick="val();"/>
                    <label for="radio9">Específico</label>
                    <input name="campo30" type="text" id="campo30"  size="38" />
                    <br />
                  </div>
                  <div style="width:48%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"><strong>Fornecimento do EPI:</strong><br />
                    <input type="radio" name="usaepi" value="Empresa" id="radioe13" />
                    <label for="radioe13">Empresa</label>
                    <input type="radio" name="usaepi" value="Cliente" id="radioe14" />
                    <label for="radioe14">Cliente</label>
                    <br />
                    <br />
                    Obs.:<br />
                    <input name="obsepi" type="text" id="obsepi"  size="45" />
                    <br />
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  ...
                  <div style="width:32%; float:left"><strong>Locação de armamentos:</strong><br />
                    <input type="radio" name="locarma" value="SIM" id="radio13" />
                    <label for="radio13">SIM</label>
                    <input type="radio" name="locarma" value="NAO" id="radio14" />
                    <label for="radio14">NÃO</label>
                    <br />
                    <br />
                  </div>
                  <div style="width:64%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Quantidade:<br />
                    <input name="campo31" type="text" id="campo31" size="15" />
                    <br />
                    Obs.:<br />
                    <textarea name="campo32" cols="45" rows="1" style="overflow:hidden; font-family:Tahoma, Geneva, sans-serif;" id="campo32"></textarea>
                    <br />
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  ...
                  <div style="width:32%; float:left"><strong>Adicional de Risco de Vida</strong><br />
                    <input type="radio" name="adicrico" value="SIM" id="radio15" />
                    <label for="radio15">SIM</label>
                    <input type="radio" name="adicrico" value="NAO" id="radio16" />
                    <label for="radio16">NÃO</label>
                    <br />
                    <br />
                  </div>
                  <div style="width:64%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Porcentual:<br />
                    <input name="campo33" type="text" id="campo33" size="15" />
                    <br />
                    Obs.:<br />
                    <textarea name="campo34" cols="45" rows="1" style="overflow:hidden; font-family:Tahoma, Geneva, sans-serif;" id="campo34"></textarea>
                    <br />
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  ...
                  <div style="width:32%; float:left"><strong>Insalubridade</strong><br />
                    <input type="radio" name="insalubri" value="SIM" id="radio17" />
                    <label for="radio17">SIM</label>
                    <input type="radio" name="insalubri" value="NAO" id="radio18" />
                    <label for="radio18">NÃO</label>
                    <br />
                    <br />
                  </div>
                  <div style="width:64%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Porcentual:<br />
                    <input name="campo35" type="text" id="campo35" size="15" />
                    <br />
                    Obs.:<br />
                    <textarea name="campo36" cols="45" rows="1" style="overflow:hidden; font-family:Tahoma, Geneva, sans-serif;" id="campo36"></textarea>
                    <br />
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  ...
                  <div id="pericu" style="display:block">
                    <div style="width:32%; float:left"><strong>Periculosidade:</strong><br />
                      <input type="radio" name="periculosi" value="SIM" id="radio19" />
                      <label for="radio19">SIM</label>
                      <input type="radio" name="periculosi" value="NAO" id="radio20" />
                      <label for="radio20">NÃO</label>
                      <br />
                      <br />
                    </div>
                    <div style="width:64%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;">Porcentual:<br />
                      <input name="campo37" type="text" id="campo37" size="15" />
                      <br />
                      Obs.:<br />
                      <textarea name="campo38" cols="45" rows="1" style="overflow:hidden; font-family:Tahoma, Geneva, sans-serif;" id="campo38"></textarea>
                      <br />
                    </div>
                    <div style="clear:both"></div>
                    <br />
                  ...
                  <div style="width:32%; float:left"> <strong>Prêmio por assiduidade:</strong><br />
                    <input type="radio" name="premassid" value="SIM" id="radio21" />
                    <label for="radio21">SIM</label>
                    <input type="radio" name="premassid" value="NAO" id="radio22" />
                    <label for="radio22">NÃO</label>
                    <br />
                    <br />
                  </div>
                  <div style="width:64%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Porcentual
                    <input name="campo39" type="text" id="campo39" size="10" />
                    <br />
                    ou<br />
                    Valor R$
                    <input name="campo40" type="text" id="campo40" size="10" />
                    cada</div>
                  <div style="clear:both"></div>
                  <br />
                  <hr style="color:#FFF" />
                  ...
                  <div style="width:42%; float:left"> <strong>Gratificação adicional</strong><br />
                    <input type="radio" name="gratadic" value="SIM" id="radio23" />
                    <label for="radio23">SIM</label>
                    <input type="radio" name="gratadic" value="NAO" id="radio24" onclick="val10();"/>
                    <label for="radio24">NÃO</label>
                    <br />
                    <br />
                    Informações da gratificação:<br />
                    <input name="campo41" type="text" id="campo41" size="35" />
                    <br />
                  </div>
                  <div style="width:54%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> Gratificação do posto ou do colaborador?<br />
                    <input type="radio" name="tipogratific" value="Posto" id="radio25" />
                    <label for="radio25">Posto</label>
                    <input type="radio" name="tipogratific" value="Colaborador" id="radio26" />
                    <label for="radio26">Colaborador</label>
                    <br />
                    <br />
                    Porcentual
                    <input name="campo42" type="text" id="campo42" size="6" />
                    ou Valor R$
                    <input name="campo43" type="text" id="campo43" size="7" />
                    cada<br />
                    <br />
                  </div>
                  <div style="clear:both"></div>
              ...
              <div >
                <div style="width: 100%; margin:0 auto;"><br />
                  <div style="width:31%; float:left"><strong>Vale Transporte:</strong><br />
                    <input type="radio" name="vtransporte" value="SIM" id="radio27" />
                    <label for="radio27">SIM</label>
                    <input type="radio" name="vtransporte" value="NAO" id="radio28" />
                  ...
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;">Ajuda de custo/Transporte no posto:<br />
                    <input type="radio" name="pajudacusto" value="SIM" id="radio35" />
                    <label for="radio35">SIM</label>
                    <input type="radio" name="pajudacusto" value="NAO" id="radio36" onclick="val2();"/>
                    <label for="radio36">NÃO</label>
                    <br />
                  </div>
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;"> Obs.:
                    <textarea name="campo44" cols="25" rows="3" id="campo44" ></textarea>
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  <hr style="color:#FFF" />
                  ...
                  <div style="width:31%; float:left"><strong>Convênio Médico:</strong><br />
                    <input type="radio" name="convmedico" value="SIM" id="radio29" />
                    <label for="radio29">SIM</label>
                    <input type="radio" name="convmedico" value="NAO" id="radio30" />
                  ...
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;">Convênio Odontológico:<br />
                    <input type="radio" name="convodonto" value="SIM" id="radio37" />
                    <label for="radio37">SIM</label>
                    <input type="radio" name="convodonto" value="NAO" id="radio38" />
                    <label for="radio38">NÃO</label>
                    <br />
                  </div>
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;"> Obs.:
                    <textarea name="campo45" cols="25" rows="3" id="campo45" ></textarea>
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  <hr style="color:#FFF" />
                  ...
                  <div style="width:31%; float:left"><strong>Visa Alimentação:</strong><br />
                    <input type="radio" name="visaaliment" value="SIM" id="radio31" />
                    <label for="radio31">SIM</label>
                    <input type="radio" name="visaaliment" value="NAO" id="radio32" onclick="val7();"/>
                  ...
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;">Valor padrão Empresa Prestadora:<br />
                    <input type="radio" name="vpempresaprest" value="SIM" id="radio39" />
                    <label for="radio39">SIM</label>
                    <input type="radio" name="vpempresaprest" value="NAO" id="radio40" onclick="val3();"/>
                    <label for="radio40">NÃO</label>
                    <br />
                  </div>
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;"> Obs.:
                    <textarea name="campo46" cols="25" rows="3" id="campo46" ></textarea>
                  </div>
                  <div style="clear:both"></div>
                  <br />
                  <hr style="color:#FFF" />
                  ...
                  <div style="width:31%; float:left"><strong>Visa Refeição:</strong><br />
                    <input type="radio" name="visarestaur" value="SIM" id="radio33" />
                    <label for="radio33">SIM</label>
                    <input type="radio" name="visarestaur" value="NAO" id="radio34" />
                  ...
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;">Refeição no posto de trabalho:<br />
                    <input type="radio" name="refpostotrab" value="SIM" id="radio41" />
                    <label for="radio41">SIM</label>
                    <input type="radio" name="refpostotrab" value="NAO" id="radio42" onclick="val4();"/>
                    <label for="radio42">NÃO</label>
                    <br />
                  </div>
                  <div style="width:31%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;"> Obs.:
                    <textarea name="campo47" cols="25" rows="3" id="campo47" ></textarea>
                  </div>
                  <div style="clear:both"></div>
                  <br />
                </div>
            ...
            <div >
              <div style="width: 100%; margin:0 auto;"><br />
                ...
                <br />
                Observações:<br />
                <textarea name="mensagem" cols="100" rows="3" id="mensagem" ></textarea>
                <br />
                <br />
                <div style="clear:both"></div>
...
if (formulario.sumulas.checked == false && formulario.sumulan.checked == false ) {alert ('Informe se a Súmula 444 está inclusa no contrato.');return false;}
	...
	if (formulario.campo21.value != '' && formulario.salario1.value == '') {alert ('Informe o Valor do 1º Salário.'); formulario.salario1.focus(); return false;}
	
	if (formulario.campo212.value != '' && formulario.salario2.value == '') {alert ('Informe o Valor do 2º Salário.'); formulario.salario2.focus(); return false;}
	
	if (formulario.campo213.value != '' && formulario.salario3.value == '') {alert ('Informe o Valor do 3º Salário.'); formulario.salario3.focus(); return false;}
