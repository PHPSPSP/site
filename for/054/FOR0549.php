...
<input name="taxaadesao" type="text" id="taxaadesao" size="20" /></div>
<div style="width:61%; float:right; border-left: 1px #6b6b6b solid; padding-left:15px;"> <strong>Valor da mensalidade:</strong><br />
<input name="mensalvalor" type="text" id="mensalvalor" size="20" /></div>
...
function enviar(){
	document.formulario.action = "geraphp3.php";
