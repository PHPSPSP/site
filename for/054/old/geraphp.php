...
$query = mysql_query('SHOW TABLE STATUS LIKE "for054fim"'); // select max(id) + 1 "Auto_increment" from for054fim
...
if ($a){
	...
	if ($id2!=""){
		$sql="delete from for054 where id='$id2'";
