            ...
            <div >
              <div style="width: 100%;  margin:0 auto;"><br />
                ...
                <div style="width:25%; float:left"> Nota fiscal:<br />
                  <input type="radio" name="ceifiscal" value="SIM" id="fiscs" />
                  <label for="fiscs">SIM</label>
                  <input type="radio" name="ceifiscal" value="NAO" id="fiscn" />
                  <label for="fiscn">NÃO</label>
                  <br />
                </div>
                <div style="width:25%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;"> SEFIP:<br />
                  <input type="radio" name="sefipcei" value="SIM" id="sefips" />
                  <label for="sefips">SIM</label>
                  <input type="radio" name="sefipcei" value="NAO" id="sefipn" />
                ...
                <div style="width:43%; float:left; border-left: 1px #6b6b6b solid; padding-left:15px;"> O nº do CEI sera único e fixo mensal:<br />
                  <input type="radio" name="ceifixo" value="SIM" id="ceis" />
                  <label for="ceis">SIM</label>
                  <input type="radio" name="ceifixo" value="NAO" id="cein" />
                ...
                Obs.:<br />
                <textarea name="obscei" cols="100" rows="1" id="obscei" ></textarea>
                <div style="clear:both"></div>
                <br />
              </div>
            </div>
...
R$ <input name="salario1" type="text" id="salario1" size="8" />
</div></div>
...
R$ <input name="salario2" type="text" id="salario2" size="8" />
</div></div>
...
R$ <input name="salario3" type="text" id="salario3" size="8" />
</div></div>
