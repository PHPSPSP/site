          ...
          <tbody>
            ...
            <tr>
              <td><table align="center" border="0" cellpadding="0" cellspacing="0" width="628">
                  <tbody>
                    <tr>
                      <td style="color: #d9534f; font-size: 16px; font-family: Helvetica, Arial, sans-serif;"> FOR 025 - Comunicado de Transferência e Alteração de Escala</td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                    </tr>
                    <tr>
                      <td style="color: #666666; font-size: 12px;  font-family: Helvetica, Arial, sans-serif;"> Olá<br>
                        <br>
                        Esse e-mail confirma a criação do  FOR 025 referente ao colaborador <b><?php echo $post->nomecol; ?></b>, verifique, imprima o PDF em anexo, e colete a assinatura do colaborador!<br>
                        <br>
                        Att.<br>
