        ...
        <div class="row">
          ...
          <form enctype="multipart/form-data" action="#" method="POST" name="formulario" id="formulario">
            ...
            <div style="width: 100%;  margin:0 auto;">Data da movimentação:<br />
              <input name="data10" type="Date" id="data10" size="25" required="required" onchange="sem_nada();" onkeydown="return false"/>
              <br />
              <br />
            ...
            <div style="width: 100%;  margin:0 auto;"><br />
              ...
              <div id="oculta4" style="display: none;">
                ...
                <div style="width:50%; float:right;  ">
                  <input class="col-md-5" type="checkbox" name="in" id="in" onchange="val15();" value="Insalubridade: " onclick="val15();"/>
                  <label class="col-md-5" for="in">Insalubridade</label>
                  <input class="col-md-3" disabled="disabled" name="int" id="int" type="text" />
                  %<br />
...
document.getElementById('oculta4').style.display = 'none'; document.getElementById('vrt').value=""; document.getElementById('salt').value=""; document.getElementById('dtt').value=""; document.getElementById('adt').value=""; document.getElementById('adt2').value=""; document.getElementById('adt3').value=""; document.getElementById('adt4').value=""; document.getElementById('adt5').value=""; document.getElementById('int').value=""; document.getElementById('prt').value=""; document.getElementById('gpt').value=""; document.getElementById('gst').value=""; document.getElementById('vtt').value=""; document.getElementById('cbt').value=""; document.getElementById('ott').value=""; document.getElementById('het').value="";document.getElementById("vr").checked=false; document.getElementById("sal").checked=false; document.getElementById("dt").checked=false; document.getElementById("ad").checked=false; document.getElementById("ad2").checked=false; document.getElementById("ad3").checked=false; document.getElementById("ad4").checked=false; document.getElementById("ad5").checked=false; document.getElementById("in").checked=false; document.getElementById("pr").checked=false; document.getElementById("gp").checked=false; document.getElementById("gs").checked=false; document.getElementById("vt").checked=false; document.getElementById("cb").checked=false; document.getElementById("ot").checked=false; document.getElementById("he").checked=false;document.formulario.vrt.disabled=true; document.formulario.salt.disabled=true; document.formulario.dtt.disabled=true; document.formulario.adt.disabled=true; document.formulario.adt2.disabled=true; document.formulario.adt3.disabled=true; document.formulario.adt4.disabled=true; document.formulario.adt5.disabled=true; document.formulario.int.disabled=true; document.formulario.prt.disabled=true; document.formulario.gpt.disabled=true; document.formulario.gst.disabled=true; document.formulario.vtt.disabled=true; document.formulario.cbt.disabled=true; document.formulario.ott.disabled=true; document.formulario.het.disabled=true;}}
...
function val15(){if(document.getElementById('in').checked){document.formulario.int.disabled=false;}else{document.getElementById('int').value=""; document.formulario.int.disabled=true;}}
