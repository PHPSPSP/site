...
$date = date("d/m/Y H:i");
  ...
  $data10 = implode("/",array_reverse(explode("-",$linha['data10'])));
	...
	if ($linha['ins'] == ""){$in_1 = "";}else{$in_1 = "<table width='100%'><tr><td width='40%'>$ins </td><td width='60%'> <strong>$inst %</strong> </td></tr></table><br>";};
        ...
        <tr>
          ...
          <table width="100%">
            ...
            <?php if ($altbenef!=""){ echo " <table width='100%'>
              <tr>
                <td><br><strong> $altbenef </strong> <br> $vr_1 $sal_1 $dt_1 $ad_1 $ad2_1 $ad3_1 $ad4_1 $ad5_1 $in_1 $pr_1 $gp_1 $gs_1 $vt_1 $cb_1 $he_1 $ot_1</td>
              </tr>
            </table>" ; } ?>
            <br>
            <br>
