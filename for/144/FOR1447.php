...
?>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 text-left small-screen-center "  > Atividade:
                  <input class="form-control"  readonly="readonly" type="text" name="ativ" id="ativ" value="ZELADORIA - EDIFÍCIOS E CONDOMÍNIOS" />
                </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 text-left small-screen-center "  >
              <div class="row ">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 70; $i <= 84; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 text-left small-screen-center "  >
              <div class="row ">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 100; $i <= 112; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 text-left small-screen-center "  > <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 34; $i <= 37; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 text-left small-screen-center "  > <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 20; $i <= 22; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 text-left small-screen-center "  > <br />
            ...
            <div class="col-md-12 text-center small-screen-center "  >
              <div class="form-group form-icon-group"><br />
                ...
                <div style="display:none"><input name="codfor" id="codfor" type="text" value="7">
