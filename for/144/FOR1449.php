...
?>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12 text-left small-screen-center "  > Atividade:
                  <input class="form-control"  readonly="readonly" type="text" name="ativ" id="ativ" value="ABERTURA - SHOPPING" />
                </div>
              ...
              <div class="row ">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 118; $i <= 126; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 text-left small-screen-center "  > <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 127; $i <= 131; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 text-left small-screen-center "  > <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 132; $i <= 136; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 text-left small-screen-center "  >
              <div class="row ">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 137; $i <= 142; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 text-left small-screen-center "  > <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 1; $i <= 2; $i++) { echo $perguntas[$i]; } ?>
                      <?php for ($i = 4; $i <= 6; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
                <div class="col-md-12 text-left small-screen-center "  > <br />
                ...
                <div class="col-md-12 col-sm-12 col-xs-12 text-center small-screen-center "  >
                  <div class="form-group form-icon-group">
                    <div class="row">
                      <?php for ($i = 113; $i <= 117; $i++) { echo $perguntas[$i]; } ?>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-12 text-center small-screen-center "  >
              <div class="form-group form-icon-group"><br />
                ...
                <div style="display:none"><input name="codfor" id="codfor" type="text" value="9">
