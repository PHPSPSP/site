            ...
            <div class="col-md-12 element-short-bottom text-left small-screen-center "  >
              <div class="row"> Usuário:
                <select class="form-control col-md-4 col-sm-6 col-xs-12" name="u">
                  ...
                  <?php
$consulta=mysql_query("SELECT e.lavanderia_usuario, c.id, c.nome FROM lavanderia_controle e, usuarios c where e.lavanderia_usuario = c.id group by e.lavanderia_usuario order by c.nome ASC "); 
			...
			<div class="col-md-12 element-short-bottom text-left small-screen-center "  >
              <div class="row">Local:<br>
                <select class="form-control col-md-4 col-sm-6 col-xs-12" name="l">
                  <option value="">Todos</option>
                  <?php
$consulta=mysql_query("SELECT e.lavanderia_local, c.lavanderia_id_local, c.lavanderia_nome_local FROM lavanderia_controle e, lavanderia_local c where e.lavanderia_local = c.lavanderia_id_local group by e.lavanderia_local order by c.lavanderia_nome_local ASC "); 
while ($dados = mysql_fetch_array($consulta)) {
            ...
            <div class="col-md-12 element-short-bottom text-left small-screen-center "  >
              <div class="row"> Enxoval: <br>
               <select class="form-control col-md-4 col-sm-6 col-xs-12" name="e">
                  <option value="">Todos</option>
                  <?php
$consulta=mysql_query("SELECT e.lavanderia_enxoval, c.lavanderia_id_enxoval, c.lavanderia_nome_enxoval FROM lavanderia_controle e, lavanderia_enxoval c where e.lavanderia_enxoval = c.lavanderia_id_enxoval group by e.lavanderia_enxoval order by c.lavanderia_nome_enxoval ASC "); 
while ($dados = mysql_fetch_array($consulta)) {
            ...
            <div class="col-md-12 element-short-bottom text-left small-screen-center "  >
              <div class="row"> Enfermeiro: <br>
               <select class="form-control col-md-4 col-sm-6 col-xs-12" name="c">
                  <option value="">Todos</option>
                  <?php
$consulta=mysql_query("SELECT e.lavanderia_enfermagem, c.lavanderia_id_enfermagem, c.lavanderia_nome_enfermagem FROM lavanderia_controle e, lavanderia_enfermagem c where e.lavanderia_enfermagem = c.lavanderia_id_enfermagem group by e.lavanderia_enfermagem order by c.lavanderia_nome_enfermagem ASC "); 
while ($dados = mysql_fetch_array($consulta)) {
