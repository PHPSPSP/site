        ...
        <div class="row">
          <div class="col-md-12 text-left small-screen-center "  ><br />
            <form action=""  method="POST" name="formulario" id="formulario" onsubmit="return validar(this);">
              ...
              <br>
              <strong>Cliente / Prospecção:</strong><br />
              <input type="button" class="btn btn-info" value="Voltar" onclick="window.location.href = 'FOR060feita.php'"/> <input size="40" type="text" id="nomecliente" name="nomecliente" value="<?= $linha['nomecliente'] ?>">
                            
              <br><br />
              <strong>Representante do Cliente:</strong><br />
              <input size="40" type="text" id="nomerepresentante" name="nomerepresentante" value="<?= $linha['nomerepresentante'] ?>">
              <br><br />

              <strong>Endereço - Local da Pestação dos Serviços:</strong><br />
              <input size="80" type="text" id="endereco" name="endereco" value="<?= $linha['endereco'] ?>">
              <br>
    ...
    $('.changeMe').css("font-family", $(this).val());});
              ...
              <div style="width: 100%; "> Serviços:<br />
                <table width="100%" border="0" class="table table-hover table-condensed element-no-bottom">
                  ...
                  <tr align="center">
                    <td><input style="width:99%" id="posto1" name="posto1" type="text" size="2" onchange="trocavirg(); valida_numero1();" value="<?= $linha['posto1'] ?>"/></td>
                    <td><input style="width:99%" id="colab1" name="colab1" type="text" size="2" onchange="trocavirg(); valida_numero1();" value="<?= $linha['colab1'] ?>"/></td>
                    <td><input style="width:99%; display:none" id="ativ1s" name="ativ1s" type="text" size="25" onchange="maislinha(); maislinha2(); return apagaefeito(this);" value="<?= $linha['ativ1s'] ?>"/>
                      <input style="width:99%" id="ativ1" name="ativ1" type="text" size="25" onchange="maislinha(); maislinha2(); return apagaefeito(this);" value="<?= $linha['ativ1'] ?>"/></td>
                    <td><input style="width:99%" id="cargh1" name="cargh1" type="text" size="14" value="<?= $linha['cargh1'] ?>"/></td>
                    <td><input style="width:99%" id="turno1" name="turno1" type="text" size="8" value="<?= $linha['turno1'] ?>"/></td>
                    <td><input style="width:99%" id="escala1" name="escala1" type="text" size="7" value="<?= $linha['escala1'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" id="vunit1" name="vunit1" type="text" size="8" onchange="trocavirg(); valida_numero1();" value="<?= $linha['vunit1'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal1" name="vtotal1" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos0" id="menos0" value="-" class="btn btn-danger col-md-12"  onclick="menos0serv(); menoslinha(); menoslinha2(); return voltaefeito(this);" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maism1" id="maism1" value="+" class="btn btn-success col-md-12"  onclick="maism1serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmaism1serv" style="display:none">
                    <td><input style="width:99%" id="posto2" name="posto2" type="text" size="2" onchange="trocavirg(); valida_numero2();" value="<?= $linha['posto2'] ?>"/></td>
                    <td><input style="width:99%" id="colab2" name="colab2" type="text" size="2" onchange="trocavirg(); valida_numero2();" value="<?= $linha['colab2'] ?>"/></td>
                    <td><input style="width:99%" id="ativ2" name="ativ2" type="text" size="25" value="<?= $linha['ativ2'] ?>" /></td>
                    <td><input style="width:99%" id="cargh2" name="cargh2" type="text" size="14" value="<?= $linha['cargh2'] ?>"/></td>
                    <td><input style="width:99%" id="turno2" name="turno2" type="text" size="8" value="<?= $linha['turno2'] ?>"/></td>
                    <td><input style="width:99%" id="escala2" name="escala2" type="text" size="7" value="<?= $linha['escala2'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" id="vunit2" name="vunit2" type="text" size="8" onchange="trocavirg(); valida_numero2();" value="<?= $linha['vunit2'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal2" name="vtotal2" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menosm1" id="menosm1" value="-" class="btn btn-danger col-md-12"  onclick="menosm1serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maism2" id="maism2"  value="+" class="btn btn-success col-md-12"  onclick="maism2serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmaism2serv" style="display:none">
                    <td><input style="width:99%" id="posto3" name="posto3" type="text" size="2" onchange="trocavirg(); valida_numero3();" value="<?= $linha['posto3'] ?>"/></td>
                    <td><input style="width:99%" id="colab3" name="colab3" type="text" size="2" onchange="trocavirg(); valida_numero3();" value="<?= $linha['colab3'] ?>"/></td>
                    <td><input style="width:99%" id="ativ3" name="ativ3" type="text" size="25" value="<?= $linha['ativ3'] ?>" /></td>
                    <td><input style="width:99%" id="cargh3" name="cargh3" type="text" size="14" value="<?= $linha['cargh3'] ?>"/></td>
                    <td><input style="width:99%" id="turno3" name="turno3" type="text" size="8" value="<?= $linha['turno3'] ?>"/></td>
                    <td><input style="width:99%" id="escala3" name="escala3" type="text" size="7" value="<?= $linha['escala3'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero3();" id="vunit3" name="vunit3" type="text" size="8" value="<?= $linha['vunit3'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal3" name="vtotal3" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menosm2" id="menosm2" value="-" class="btn btn-danger col-md-12"  onclick="menosm2serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maism3" id="maism3"  value="+" class="btn btn-success col-md-12"  onclick="maism3serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmaism3serv" style="display:none">
                    <td><input style="width:99%" id="posto4" name="posto4" type="text" size="2" onchange="trocavirg(); valida_numero4();" value="<?= $linha['posto4'] ?>"/></td>
                    <td><input style="width:99%" id="colab4" name="colab4" type="text" size="2" onchange="trocavirg(); valida_numero4();" value="<?= $linha['colab4'] ?>"/></td>
                    <td><input style="width:99%" id="ativ4" name="ativ4" type="text" size="25" value="<?= $linha['ativ4'] ?>" /></td>
                    <td><input style="width:99%" id="cargh4" name="cargh4" type="text" size="14"value="<?= $linha['cargh4'] ?>" /></td>
                    <td><input style="width:99%" id="turno4" name="turno4" type="text" size="8" value="<?= $linha['turno4'] ?>"/></td>
                    <td><input style="width:99%" id="escala4" name="escala4" type="text" size="7" value="<?= $linha['escala4'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero4();" id="vunit4" name="vunit4" type="text" size="8" value="<?= $linha['vunit4'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal4" name="vtotal4" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menosm3" id="menosm3" value="-" class="btn btn-danger col-md-12"  onclick="menosm3serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais1" id="mais1"  value="+" class="btn btn-success col-md-12"  onclick="mais1serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais1serv" style="display:none">
                    <td><input style="width:99%" id="posto5" name="posto5" type="text" size="2" onchange="trocavirg(); valida_numero5();" value="<?= $linha['posto5'] ?>"/></td>
                    <td><input style="width:99%" id="colab5" name="colab5" type="text" size="2" onchange="trocavirg(); valida_numero5();" value="<?= $linha['colab5'] ?>"/></td>
                    <td><input style="width:99%" id="ativ5" name="ativ5" type="text" size="25" value="<?= $linha['ativ5'] ?>" /></td>
                    <td><input style="width:99%" id="cargh5" name="cargh5" type="text" size="14" value="<?= $linha['cargh5'] ?>"/></td>
                    <td><input style="width:99%" id="turno5" name="turno5" type="text" size="8" value="<?= $linha['turno5'] ?>"/></td>
                    <td><input style="width:99%" id="escala5" name="escala5" type="text" size="7" value="<?= $linha['escala5'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero5();" id="vunit5" name="vunit5" type="text" size="8" value="<?= $linha['vunit5'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal5" name="vtotal5" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos1" id="menos1" value="-" class="btn btn-danger col-md-12"  onclick="menos1serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais2" id="mais2"  value="+" class="btn btn-success col-md-12"  onclick="mais2serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais2serv" style="display:none">
                    <td><input style="width:99%" id="posto6" name="posto6" type="text" size="2" onchange="trocavirg(); valida_numero6();" value="<?= $linha['posto6'] ?>"/></td>
                    <td><input style="width:99%" id="colab6" name="colab6" type="text" size="2" onchange="trocavirg(); valida_numero6();" value="<?= $linha['colab6'] ?>"/></td>
                    <td><input style="width:99%" id="ativ6" name="ativ6" type="text" size="25" value="<?= $linha['ativ6'] ?>" /></td>
                    <td><input style="width:99%" id="cargh6" name="cargh6" type="text" size="14" value="<?= $linha['cargh6'] ?>"/></td>
                    <td><input style="width:99%" id="turno6" name="turno6" type="text" size="8" value="<?= $linha['turno6'] ?>"/></td>
                    <td><input style="width:99%" id="escala6" name="escala6" type="text" size="7" value="<?= $linha['escala6'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero6();" id="vunit6" name="vunit6" type="text" size="8" value="<?= $linha['vunit6'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal6" name="vtotal6" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos2" id="menos2" value="-" class="btn btn-danger col-md-12"  onclick="menos2serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais3" id="mais3"  value="+" class="btn btn-success col-md-12"  onclick="mais3serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais3serv" style="display:none">
                    <td><input style="width:99%" id="posto7" name="posto7" type="text" size="2" onchange="trocavirg(); valida_numero7();" value="<?= $linha['posto7'] ?>"/></td>
                    <td><input style="width:99%" id="colab7" name="colab7" type="text" size="2" onchange="trocavirg(); valida_numero7();" value="<?= $linha['colab7'] ?>"/></td>
                    <td><input style="width:99%" id="ativ7" name="ativ7" type="text" size="25" value="<?= $linha['ativ7'] ?>" /></td>
                    <td><input style="width:99%" id="cargh7" name="cargh7" type="text" size="14" value="<?= $linha['cargh7'] ?>"/></td>
                    <td><input style="width:99%" id="turno7" name="turno7" type="text" size="8" value="<?= $linha['turno7'] ?>"/></td>
                    <td><input style="width:99%" id="escala7" name="escala7" type="text" size="7" value="<?= $linha['escala7'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero7();" id="vunit7" name="vunit7" type="text" size="8" value="<?= $linha['vunit7'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal7" name="vtotal7" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos3" id="menos3" value="-" class="btn btn-danger col-md-12"  onclick="menos3serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais4" id="mais4"  value="+" class="btn btn-success col-md-12"  onclick="mais4serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais4serv" style="display:none">
                    <td><input style="width:99%" id="posto8" name="posto8" type="text" size="2" onchange="trocavirg(); valida_numero8();" value="<?= $linha['posto8'] ?>"/></td>
                    <td><input style="width:99%" id="colab8" name="colab8" type="text" size="2" onchange="trocavirg(); valida_numero8();" value="<?= $linha['colab8'] ?>"/></td>
                    <td><input style="width:99%" id="ativ8" name="ativ8" type="text" size="25" value="<?= $linha['ativ8'] ?>" /></td>
                    <td><input style="width:99%" id="cargh8" name="cargh8" type="text" size="14" value="<?= $linha['cargh8'] ?>"/></td>
                    <td><input style="width:99%" id="turno8" name="turno8" type="text" size="8" value="<?= $linha['turno8'] ?>"/></td>
                    <td><input style="width:99%" id="escala8" name="escala8" type="text" size="7" value="<?= $linha['escala8'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero8();" id="vunit8" name="vunit8" type="text" size="8" value="<?= $linha['vunit8'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal8" name="vtotal8" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos4" id="menos4" value="-" class="btn btn-danger col-md-12"  onclick="menos4serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais5" id="mais5"  value="+" class="btn btn-success col-md-12"  onclick="mais5serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais5serv" style="display:none">
                    <td><input style="width:99%" id="posto9" name="posto9" type="text" size="2" onchange="trocavirg(); valida_numero9();" value="<?= $linha['posto9'] ?>"/></td>
                    <td><input style="width:99%" id="colab9" name="colab9" type="text" size="2" onchange="trocavirg(); valida_numero9();" value="<?= $linha['colab9'] ?>"/></td>
                    <td><input style="width:99%" id="ativ9" name="ativ9" type="text" size="25" value="<?= $linha['ativ9'] ?>" /></td>
                    <td><input style="width:99%" id="cargh9" name="cargh9" type="text" size="14" value="<?= $linha['cargh9'] ?>"/></td>
                    <td><input style="width:99%" id="turno9" name="turno9" type="text" size="8" value="<?= $linha['turno9'] ?>"/></td>
                    <td><input style="width:99%" id="escala9" name="escala9" type="text" size="7" value="<?= $linha['escala9'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero9();" id="vunit9" name="vunit9" type="text" size="8" value="<?= $linha['vunit9'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal9" name="vtotal9" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos5" id="menos5" value="-" class="btn btn-danger col-md-12"  onclick="menos5serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais6" id="mais6"  value="+" class="btn btn-success col-md-12"  onclick="mais6serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais6serv" style="display:none">
                    <td><input style="width:99%" id="posto10" name="posto10" type="text" size="2" onchange="trocavirg(); valida_numero10();" value="<?= $linha['posto10'] ?>"/></td>
                    <td><input style="width:99%" id="colab10" name="colab10" type="text" size="2" onchange="trocavirg(); valida_numero10();" value="<?= $linha['colab10'] ?>"/></td>
                    <td><input style="width:99%" id="ativ10" name="ativ10" type="text" size="25" value="<?= $linha['ativ10'] ?>" /></td>
                    <td><input style="width:99%" id="cargh10" name="cargh10" type="text" size="14" value="<?= $linha['cargh10'] ?>"/></td>
                    <td><input style="width:99%" id="turno10" name="turno10" type="text" size="8" value="<?= $linha['turno10'] ?>"/></td>
                    <td><input style="width:99%" id="escala10" name="escala10" type="text" size="7" value="<?= $linha['escala10'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero10();" id="vunit10" name="vunit10" type="text" size="8" value="<?= $linha['vunit10'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal10" name="vtotal10" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos6" id="menos6" value="-" class="btn btn-danger col-md-12"  onclick="menos6serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais7" id="mais7"  value="+" class="btn btn-success col-md-12"  onclick="mais7serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais7serv" style="display:none">
                    <td><input style="width:99%" id="posto11" name="posto11" type="text" size="2" onchange="trocavirg(); valida_numero11();" value="<?= $linha['posto11'] ?>"/></td>
                    <td><input style="width:99%" id="colab11" name="colab11" type="text" size="2" onchange="trocavirg(); valida_numero11();" value="<?= $linha['colab11'] ?>"/></td>
                    <td><input style="width:99%" id="ativ11" name="ativ11" type="text" size="25" value="<?= $linha['ativ11'] ?>" /></td>
                    <td><input style="width:99%" id="cargh11" name="cargh11" type="text" size="14" value="<?= $linha['cargh11'] ?>"/></td>
                    <td><input style="width:99%" id="turno11" name="turno11" type="text" size="8" value="<?= $linha['turno11'] ?>"/></td>
                    <td><input style="width:99%" id="escala11" name="escala11" type="text" size="7" value="<?= $linha['escala11'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero11();" id="vunit11" name="vunit11" type="text" size="8" value="<?= $linha['vunit11'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal11" name="vtotal11" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos7" id="menos7" value="-" class="btn btn-danger col-md-12"  onclick="menos7serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais8" id="mais8"  value="+" class="btn btn-success col-md-12"  onclick="mais8serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais8serv" style="display:none">
                    <td><input style="width:99%" id="posto12" name="posto12" type="text" size="2" onchange="trocavirg(); valida_numero12();" value="<?= $linha['posto12'] ?>"/></td>
                    <td><input style="width:99%" id="colab12" name="colab12" type="text" size="2" onchange="trocavirg(); valida_numero12();" value="<?= $linha['colab12'] ?>"/></td>
                    <td><input style="width:99%" id="ativ12" name="ativ12" type="text" size="25" value="<?= $linha['ativ12'] ?>" /></td>
                    <td><input style="width:99%" id="cargh12" name="cargh12" type="text" size="14" value="<?= $linha['cargh12'] ?>"/></td>
                    <td><input style="width:99%" id="turno12" name="turno12" type="text" size="8" value="<?= $linha['turno12'] ?>"/></td>
                    <td><input style="width:99%" id="escala12" name="escala12" type="text" size="7" value="<?= $linha['escala12'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero12();" id="vunit12" name="vunit12" type="text" size="8" value="<?= $linha['vunit12'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal12" name="vtotal12" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos8" id="menos8" value="-" class="btn btn-danger col-md-12"  onclick="menos8serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais9" id="mais9"  value="+" class="btn btn-success col-md-12"  onclick="mais9serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais9serv" style="display:none">
                    <td><input style="width:99%" id="posto13" name="posto13" type="text" size="2" onchange="trocavirg(); valida_numero13();" value="<?= $linha['posto13'] ?>"/></td>
                    <td><input style="width:99%" id="colab13" name="colab13" type="text" size="2" onchange="trocavirg(); valida_numero13();" value="<?= $linha['colab13'] ?>"/></td>
                    <td><input style="width:99%" id="ativ13" name="ativ13" type="text" size="25" value="<?= $linha['ativ13'] ?>" /></td>
                    <td><input style="width:99%" id="cargh13" name="cargh13" type="text" size="14" value="<?= $linha['cargh13'] ?>"/></td>
                    <td><input style="width:99%" id="turno13" name="turno13" type="text" size="8" value="<?= $linha['turno13'] ?>"/></td>
                    <td><input style="width:99%" id="escala13" name="escala13" type="text" size="7" value="<?= $linha['escala13'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero13();" id="vunit13" name="vunit13" type="text" size="8" value="<?= $linha['vunit13'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal13" name="vtotal13" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos9" id="menos9" value="-" class="btn btn-danger col-md-12"  onclick="menos9serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais10" id="mais10"  value="+" class="btn btn-success col-md-12"  onclick="mais10serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais10serv" style="display:none">
                    <td><input style="width:99%" id="posto14" name="posto14" type="text" size="2" onchange="trocavirg(); valida_numero14();" value="<?= $linha['posto14'] ?>"/></td>
                    <td><input style="width:99%" id="colab14" name="colab14" type="text" size="2" onchange="trocavirg(); valida_numero14();" value="<?= $linha['colab14'] ?>"/></td>
                    <td><input style="width:99%" id="ativ14" name="ativ14" type="text" size="25" value="<?= $linha['ativ14'] ?>"/></td>
                    <td><input style="width:99%" id="cargh14" name="cargh14" type="text" size="14" value="<?= $linha['cargh14'] ?>"/></td>
                    <td><input style="width:99%" id="turno14" name="turno14" type="text" size="8" value="<?= $linha['turno14'] ?>"/></td>
                    <td><input style="width:99%" id="escala14" name="escala14" type="text" size="7" value="<?= $linha['escala14'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero14();" id="vunit14" name="vunit14" type="text" size="8" value="<?= $linha['vunit14'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal14" name="vtotal14" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos10" id="menos10" value="-" class="btn btn-danger col-md-12"  onclick="menos10serv(); menoslinha(); menoslinha2();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="mais11" id="mais11"  value="+" class="btn btn-success col-md-12"  onclick="mais11serv(); maislinha(); maislinha2();" /></td>
                  </tr>
                  <tr align="center" id="divmais11serv" style="display:none">
                    <td><input style="width:99%" id="posto15" name="posto15" type="text" size="2" onchange="trocavirg(); valida_numero15();" value="<?= $linha['posto15'] ?>"/></td>
                    <td><input style="width:99%" id="colab15" name="colab15" type="text" size="2" onchange="trocavirg(); valida_numero15();" value="<?= $linha['colab15'] ?>"/></td>
                    <td><input style="width:99%" id="ativ15" name="ativ15" type="text" size="25" onchange="maislinha(); maislinha2();" value="<?= $linha['ativ15'] ?>"/></td>
                    <td><input style="width:99%" id="cargh15" name="cargh15" type="text" size="14" value="<?= $linha['cargh15'] ?>"/></td>
                    <td><input style="width:99%" id="turno15" name="turno15" type="text" size="8" value="<?= $linha['turno15'] ?>"/></td>
                    <td><input style="width:99%" id="escala15" name="escala15" type="text" size="7" value="<?= $linha['escala15'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numero15();" id="vunit15" name="vunit15" type="text" size="8" value="<?= $linha['vunit15'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotal15" name="vtotal15" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menos11" id="menos11" value="-" class="btn btn-danger col-md-12"  onclick="menos11serv(); menoslinha(); menoslinha2();" /></td>
                ...
                <table width="100%" border="0" class="table table-hover table-condensed element-no-bottom">
                  ...
                  <tr align="center">
                    <td><input style="width:99%" id="quant1" name="quant1" type="text" size="2" onchange="trocavirg(); valida_numeroe1();" value="<?= $linha['quant1'] ?>"/></td>
                    <td><input style="width:99%; display:none" id="equip1s" name="equip1s" type="text" size="25" onchange="maislinha(); maislinha3(); return apagaefeito2(this);" value="<?= $linha['equip1s'] ?>"/>
                      <input style="width:99%" id="equip1" name="equip1" type="text" size="25" onchange="maislinha(); maislinha3(); return apagaefeito2(this);" value="<?= $linha['equip1'] ?>"/></td>
                    <td><input style="width:99%" id="descri1" name="descri1" type="text" size="35" value="<?= $linha['descri1'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe1();" id="vunite1" name="vunite1" type="text" size="8" value="<?= $linha['vunite1'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale1" name="vtotale1" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose0" id="menose0" value="-" class="btn btn-danger col-md-12"  onclick="menose0serv(); menoslinha(); menoslinha3(); return voltaefeito2(this);" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise1" id="maise1"  value="+" class="btn btn-success col-md-12"  onclick="maise1serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmai2sequip" style="display:none">
                    <td><input style="width:99%" id="quant2" name="quant2" type="text" size="2" onchange="trocavirg(); valida_numeroe2();" value="<?= $linha['quant2'] ?>"/></td>
                    <td><input style="width:99%" id="equip2" name="equip2" type="text" size="25" value="<?= $linha['equip2'] ?>"/></td>
                    <td><input style="width:99%" id="descri2" name="descri2" type="text" size="35" value="<?= $linha['descri2'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe2();" id="vunite2" name="vunite2" type="text" size="8" value="<?= $linha['vunite2'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale2" name="vtotale2" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose1" id="menose1" value="-" class="btn btn-danger col-md-12"  onclick="menose1serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise2" id="maise2"  value="+" class="btn btn-success col-md-12"  onclick="maise2serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais3equip" style="display:none">
                    <td><input style="width:99%" id="quant3" name="quant3" type="text" size="2" onchange="trocavirg(); valida_numeroe3();" value="<?= $linha['quant3'] ?>"/></td>
                    <td><input style="width:99%" id="equip3" name="equip3" type="text" size="25" value="<?= $linha['equip3'] ?>"/></td>
                    <td><input style="width:99%" id="descri3" name="descri3" type="text" size="35" value="<?= $linha['descri3'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe3();" id="vunite3" name="vunite3" type="text" size="8" value="<?= $linha['vunite3'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale3" name="vtotale3" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose2" id="menose2" value="-" class="btn btn-danger col-md-12"  onclick="menose2serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise3" id="maise3"  value="+" class="btn btn-success col-md-12"  onclick="maise3serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais4equip" style="display:none">
                    <td><input style="width:99%" id="quant4" name="quant4" type="text" size="2" onchange="trocavirg(); valida_numeroe4();" value="<?= $linha['quant4'] ?>"/></td>
                    <td><input style="width:99%" id="equip4" name="equip4" type="text" size="25" value="<?= $linha['equip4'] ?>"/></td>
                    <td><input style="width:99%" id="descri4" name="descri4" type="text" size="35" value="<?= $linha['descri4'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe4();" id="vunite4" name="vunite4" type="text" size="8" value="<?= $linha['vunite4'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale4" name="vtotale4" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose3" id="menose3" value="-" class="btn btn-danger col-md-12"  onclick="menose3serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise4" id="maise4"  value="+" class="btn btn-success col-md-12"  onclick="maise4serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais5equip" style="display:none">
                    <td><input style="width:99%" id="quant5" name="quant5" type="text" size="2" onchange="trocavirg(); valida_numeroe5();" value="<?= $linha['quant5'] ?>"/></td>
                    <td><input style="width:99%" id="equip5" name="equip5" type="text" size="25" value="<?= $linha['equip5'] ?>"/></td>
                    <td><input style="width:99%" id="descri5" name="descri5" type="text" size="35" value="<?= $linha['descri5'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe5();" id="vunite5" name="vunite5" type="text" size="8" value="<?= $linha['vunite5'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale5" name="vtotale5" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose4" id="menose4" value="-" class="btn btn-danger col-md-12"  onclick="menose4serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise5" id="maise5"  value="+" class="btn btn-success col-md-12"  onclick="maise5serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais6equip" style="display:none">
                    <td><input style="width:99%" id="quant6" name="quant6" type="text" size="2" onchange="trocavirg(); valida_numeroe6();" value="<?= $linha['quant6'] ?>"/></td>
                    <td><input style="width:99%" id="equip6" name="equip6" type="text" size="25" value="<?= $linha['equip6'] ?>"/></td>
                    <td><input style="width:99%" id="descri6" name="descri6" type="text" size="35" value="<?= $linha['descri6'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe6();" id="vunite6" name="vunite6" type="text" size="8" value="<?= $linha['vunite6'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale6" name="vtotale6" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose5" id="menose5" value="-" class="btn btn-danger col-md-12"  onclick="menose5serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise6" id="maise6"  value="+" class="btn btn-success col-md-12"  onclick="maise6serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais7equip" style="display:none">
                    <td><input style="width:99%" id="quant7" name="quant7" type="text" size="2" onchange="trocavirg(); valida_numeroe7();" value="<?= $linha['quant7'] ?>"/></td>
                    <td><input style="width:99%" id="equip7" name="equip7" type="text" size="25" value="<?= $linha['equip7'] ?>"/></td>
                    <td><input style="width:99%" id="descri7" name="descri7" type="text" size="35" value="<?= $linha['descri7'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe7();" id="vunite7" name="vunite7" type="text" size="8" value="<?= $linha['vunite7'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale7" name="vtotale7" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose6" id="menose6" value="-" class="btn btn-danger col-md-12"  onclick="menose6serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise7" id="maise7"  value="+" class="btn btn-success col-md-12"  onclick="maise7serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais8equip" style="display:none">
                    <td><input style="width:99%" id="quant8" name="quant8" type="text" size="2" onchange="trocavirg(); valida_numeroe8();" value="<?= $linha['quant8'] ?>"/></td>
                    <td><input style="width:99%" id="equip8" name="equip8" type="text" size="25" value="<?= $linha['equip8'] ?>"/></td>
                    <td><input style="width:99%" id="descri8" name="descri8" type="text" size="35" value="<?= $linha['descri8'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe8();" id="vunite8" name="vunite8" type="text" size="8" value="<?= $linha['vunite8'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale8" name="vtotale8" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose7" id="menose7" value="-" class="btn btn-danger col-md-12"  onclick="menose7serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise8" id="maise8"  value="+" class="btn btn-success col-md-12"  onclick="maise8serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais9equip" style="display:none">
                    <td><input style="width:99%" id="quant9" name="quant9" type="text" size="2" onchange="trocavirg(); valida_numeroe9();" value="<?= $linha['quant9'] ?>"/></td>
                    <td><input style="width:99%" id="equip9" name="equip9" type="text" size="25" value="<?= $linha['equip9'] ?>"/></td>
                    <td><input style="width:99%" id="descri9" name="descri9" type="text" size="35" value="<?= $linha['descri9'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe9();" id="vunite9" name="vunite9" type="text" size="8" value="<?= $linha['vunite9'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale9" name="vtotale9" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose8" id="menose8" value="-" class="btn btn-danger col-md-12"  onclick="menose8serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise9" id="maise9"  value="+" class="btn btn-success col-md-12"  onclick="maise9serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais10equip" style="display:none">
                    <td><input style="width:99%" id="quant10" name="quant10" type="text" size="2" onchange="trocavirg(); valida_numeroe10();" value="<?= $linha['quant10'] ?>"/></td>
                    <td><input style="width:99%" id="equip10" name="equip10" type="text" size="25" value="<?= $linha['equip10'] ?>"/></td>
                    <td><input style="width:99%" id="descri10" name="descri10" type="text" size="35" value="<?= $linha['descri10'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe10();" id="vunite10" name="vunite10" type="text" size="8" value="<?= $linha['vunite10'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale10" name="vtotale10" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose9" id="menose9" value="-" class="btn btn-danger col-md-12"  onclick="menose9serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise10" id="maise10"  value="+" class="btn btn-success col-md-12"  onclick="maise10serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais11equip" style="display:none">
                    <td><input style="width:99%" id="quant11" name="quant11" type="text" size="2" onchange="trocavirg(); valida_numeroe11();" value="<?= $linha['quant11'] ?>"/></td>
                    <td><input style="width:99%" id="equip11" name="equip11" type="text" size="25" value="<?= $linha['equip11'] ?>"/></td>
                    <td><input style="width:99%" id="descri11" name="descri11" type="text" size="35" value="<?= $linha['descri11'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe11();" id="vunite11" name="vunite11" type="text" size="8" value="<?= $linha['vunite11'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale11" name="vtotale11" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose10" id="menose10" value="-" class="btn btn-danger col-md-12"  onclick="menose10serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise11" id="maise11"  value="+" class="btn btn-success col-md-12"  onclick="maise11serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais12equip" style="display:none">
                    <td><input style="width:99%" id="quant12" name="quant12" type="text" size="2" onchange="trocavirg(); valida_numeroe12();" value="<?= $linha['quant12'] ?>"/></td>
                    <td><input style="width:99%" id="equip12" name="equip12" type="text" size="25" value="<?= $linha['equip12'] ?>"/></td>
                    <td><input style="width:99%" id="descri12" name="descri12" type="text" size="35" value="<?= $linha['descri12'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe12();" id="vunite12" name="vunite12" type="text" size="8" value="<?= $linha['vunite12'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale12" name="vtotale12" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose11" id="menose11" value="-" class="btn btn-danger col-md-12"  onclick="menose11serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise12" id="maise12"  value="+" class="btn btn-success col-md-12"  onclick="maise12serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais13equip" style="display:none">
                    <td><input style="width:99%" id="quant13" name="quant13" type="text" size="2" onchange="trocavirg(); valida_numeroe13();" value="<?= $linha['quant13'] ?>"/></td>
                    <td><input style="width:99%" id="equip13" name="equip13" type="text" size="25" value="<?= $linha['equip13'] ?>"/></td>
                    <td><input style="width:99%" id="descri13" name="descri13" type="text" size="35" value="<?= $linha['descri13'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe13();" id="vunite13" name="vunite13" type="text" size="8" value="<?= $linha['vunite13'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale13" name="vtotale13" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose12" id="menose12" value="-" class="btn btn-danger col-md-12"  onclick="menose12serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise13" id="maise13"  value="+" class="btn btn-success col-md-12"  onclick="maise13serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais14equip" style="display:none">
                    <td><input style="width:99%" id="quant14" name="quant14" type="text" size="2" onchange="trocavirg(); valida_numeroe14();" value="<?= $linha['quant14'] ?>"/></td>
                    <td><input style="width:99%" id="equip14" name="equip14" type="text" size="25" value="<?= $linha['equip14'] ?>"/></td>
                    <td><input style="width:99%" id="descri14" name="descri14" type="text" size="35" value="<?= $linha['descri14'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe14();" id="vunite14" name="vunite14" type="text" size="8" value="<?= $linha['vunite14'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale14" name="vtotale14" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose13" id="menose13" value="-" class="btn btn-danger col-md-12"  onclick="menose13serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="maise14" id="maise14"  value="+" class="btn btn-success col-md-12"  onclick="maise14serv(); maislinha(); maislinha3();" /></td>
                  </tr>
                  <tr align="center" id="divmais15equip" style="display:none">
                    <td><input style="width:99%" id="quant15" name="quant15" type="text" size="2" onchange="trocavirg(); valida_numeroe15();" value="<?= $linha['quant15'] ?>"/></td>
                    <td><input style="width:99%" id="equip15" name="equip15" type="text" size="25" onchange="maislinha(); maislinha3();" value="<?= $linha['equip15'] ?>"/></td>
                    <td><input style="width:99%" id="descri15" name="descri15" type="text" size="35" value="<?= $linha['descri15'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" onchange="trocavirg(); valida_numeroe15();" id="vunite15" name="vunite15" type="text" size="8" value="<?= $linha['vunite15'] ?>"/></td>
                    <td><input style="width:99%; text-align:right" readonly="readonly" id="vtotale15" name="vtotale15" type="text" size="8" /></td>
                    <td align="center" valign="middle"><input style="width:99%; display:none" type="button" name="menose14" id="menose14" value="-" class="btn btn-danger col-md-12"  onclick="menose14serv(); menoslinha(); menoslinha3();" /></td>
                    <td align="center" valign="middle"></td>
                  </tr>
                  <tr style="color:#FFFFFF; font-size:16px;">
                  ...
                  <textarea name="obsescalae" style="width:100%" cols="100%" rows="2" id="obsescalae" ><?= $linha['obsescalae']==""?"Todos os equipamentos, materiais e insumos para a realização das atividades, serão fornecidos pela SPSP sem ônus para o Cliente. Será de responsabilidade da SPSP a manutenção dos equipamentos e acessórios disponibilizados para a realização das atividades em conformidade com o escopo.":$linha['obsescalae']; ?></textarea>
                <br />
                <br />
...
<strong>Informar valores dos impostos?<br />
                ...
                <table id="tabelaimp" width="60%" border="0" style="display:none" class="table table-hover table-condensed">
                  ...
                  <tr style="color:#FFFFFF; font-size:16px;">
                    <td colspan="2"><br /><div class="btn-group" data-toggle="buttons"><label class="btn btn-primary col-md-12" for="option13" ><input type="checkbox" name="option13" id="option13" value="sim" />Incluir Observação na Proposta</label>
                  </div>
<textarea name="obsimposto" style="width:100%" id="obsimposto" cols="100%" rows="2" >
<?= $linha['obsimposto']==""?"Se tributos forem criados ou alíquotas forem modificadas durante a vigência do contrato e isso aumentar ou reduzir o ônus, o preço será revisto, a fim de adequá-lo às mudanças.":$linha['obsimposto']; ?></textarea></td>
                  </tr>
                    <tr>
                    <td><br />
...
<iframe src="http://www3.employer.com.br/TabelaISS.aspx?templatenovo=true" max-width="650px" width="100%" height="300px"></iframe>
                ...
                <br /><textarea name="pagamento" style="width:100%" id="pagamento" cols="100%" rows="3" ><?= $linha['pagamento']==""?"A fatura correspondente à execução dos serviços contratados será sempre emitida e entregue com tempo hábil para as devidas conferências. A cobrança é feita por rede bancária e o vencimento será no 28º dia do mês da realização dos serviços. Vencido este prazo, a cobrança dos encargos financeiros incide sobre o montante da fatura até a data do pagamento.":$linha['pagamento']; ?></textarea>
                ...
                <br /><textarea name="beneficios" style="width:100%" id="beneficios" cols="100%" rows="1" ><?= $linha['beneficios']==""?"Vale Alimentação; Vale Refeição; Vale Transporte; Uniforme Completo; EPI´s; Assistência Social Familiar Sindical.":$linha['beneficios']; ?></textarea>
                <br />
                <br />
                <strong><div class="btn-group" data-toggle="buttons"><label class="btn btn-primary col-md-12" for="option1"><input type="checkbox" name="option1" id="option1" value="sim"/>Incluir na Proposta</label>
                  </div>&nbsp;&nbsp;Súmula 444:</strong>
                <br /><textarea name="cobraferiado" style="width:100%" id="cobraferiado" cols="100%" rows="2" ><?= $linha['cobraferiado']==""?"O colaborador da escala 12x36 que trabalhar no feriado receberá hora extra 100% referente a esse dia e a cobrança será repassada ao cliente no valor de 100% da hora do contrato, caso esse valor não esteja incluso mensalmente no contrato, será cobrado a parte.":$linha['cobraferiado']; ?></textarea>
                <br />
                <br />
                ...
                <br /><textarea name="reajuste" style="width:100%" id="reajuste" cols="100%" rows="1" ><?= $linha['reajuste']==""?"Os preços mensais serão reajustados a partir do 1º dia da data base da categoria, decorrente da convenção, dissídio ou acordo coletivo.":$linha['reajuste']; ?></textarea>
                <br />
                <br />
                ...
                <br /><textarea name="validadecont" style="width:100%" id="validadecont" cols="100%" rows="1" ><?= $linha['validadecont']==""?"Em decorrência dos investimentos e condições diferenciadas apresentadas, o tempo mínimo de contrato será de 12 (doze) meses.":$linha['validadecont']; ?></textarea>
                <br />
                <br />
                ...
                <br /><textarea name="inicio" style="width:100%" id="inicio" cols="100%" rows="2" ><?= $linha['inicio']==""?"O prazo para implantação será de 30 dias após a aprovação da proposta. Caso haja necessidade de implantação emergencial, será avaliada uma maneira melhor para atender a necessidade.":$linha['inicio']; ?></textarea>
                <br />
                <br />
                ...
                <br /><textarea name="validadeprop" style="width:100%" id="validadeprop" cols="100%" rows="1" ><?= $linha['validadeprop']==""?"A proposta é válida por 30 dias, a contar desta data.":$linha['validadeprop']; ?></textarea>
                <br />
                <br />
                ...
                <br /><textarea name="aditivo" style="width:100%" id="aditivo" cols="100%" rows="2" ><?= $linha['aditivo']==""?"Com a assinatura do Termo de Aceite, a presente proposta comercial passa a fazer parte integral do contrato de prestação de serviços firmados entre as partes na forma de anexo. O presente contrato passa a ter o valor mensal de R$ XX.XXX,XX. As demais cláusulas contratuais permanecem inalteradas.":$linha['aditivo']; ?></textarea>
                <br />
                <br />
                ...
                <br /><textarea name="obsgeral" style="width:100%" id="obsgeral" cols="100%" rows="3" ><?= $linha['obsgeral']; ?></textarea>
              </div>
              <br />
              <br />
<!--              <strong>A proposta será enviada para o cliente por e-mail?
              ...
              <input type="submit" class="btn btn-default" value="Gerar Proposta" onClick="somatudo(); calclinhas(); this.form.target='_self';return true;" target="_self" >
              <input type="button" class="btn btn-info" value="Voltar" onclick="window.location.href = 'FOR060feita.php'"/>
            </form>
          </div>
          <div class="col-md-12 text-left small-screen-center "  > <br />
            <br />
...
document.getElementById('codpro').value="<?php echo $codpro2; ?>";
	
if (document.getElementById('ativ1').value == ''){}
else{mais0serv(); maislinha(); maislinha2(); ativ1.onchange = ''; soma(); somat(); somanfb(); somanft(); if (document.getElementById('ativ2').value == ''){}
else{maism1serv(); maislinha(); maislinha2(); soma2(); somat(); somanfb(); somanft(); if (document.getElementById('ativ3').value == ''){}
else{maism2serv(); maislinha(); maislinha2(); soma3(); somat(); somanfb(); somanft(); if (document.getElementById('ativ4').value == ''){}
else{maism3serv(); maislinha(); maislinha2(); soma4(); somat(); somanfb(); somanft(); if (document.getElementById('ativ5').value == ''){}
else{maism4serv(); maislinha(); maislinha2(); soma5(); somat(); somanfb(); somanft(); if (document.getElementById('ativ6').value == ''){}
else{maism5serv(); maislinha(); maislinha2(); soma6(); somat(); somanfb(); somanft(); if (document.getElementById('ativ7').value == ''){}
else{maism6serv(); maislinha(); maislinha2(); soma7(); somat(); somanfb(); somanft(); if (document.getElementById('ativ8').value == ''){}
else{maism7serv(); maislinha(); maislinha2(); soma8(); somat(); somanfb(); somanft(); if (document.getElementById('ativ9').value == ''){}
else{maism8serv(); maislinha(); maislinha2(); soma9(); somat(); somanfb(); somanft(); if (document.getElementById('ativ10').value == ''){}
else{maism9serv(); maislinha(); maislinha2(); soma10(); somat(); somanfb(); somanft(); if (document.getElementById('ativ11').value == ''){}
else{maism10serv(); maislinha(); maislinha2(); soma11(); somat(); somanfb(); somanft(); if (document.getElementById('ativ12').value == ''){}
else{maism11serv(); maislinha(); maislinha2(); soma12(); somat(); somanfb(); somanft(); if (document.getElementById('ativ13').value == ''){}
else{maism12serv(); maislinha(); maislinha2(); soma13(); somat(); somanfb(); somanft(); if (document.getElementById('ativ14').value == ''){}
else{maism13serv(); maislinha(); maislinha2(); soma14(); somat(); somanfb(); somanft(); if (document.getElementById('ativ15').value == ''){}
else{maism14serv(); maislinha(); maislinha2(); soma15(); somat(); somanfb(); somanft(); };};};};};};};};};};};};};};};

if (document.getElementById('equip1').value == ''){}
else{maise0serv(); maislinha(); maislinha3(); equip1.onchange = ''; somae(); somaet(); somanfb(); somanft(); if (document.getElementById('equip2').value == ''){}
else{maise1serv(); maislinha(); maislinha3(); somae2(); somaet(); somanfb(); somanft(); if (document.getElementById('equip3').value == ''){}
else{maise2serv(); maislinha(); maislinha3(); somae3(); somaet(); somanfb(); somanft(); if (document.getElementById('equip4').value == ''){}
else{maise3serv(); maislinha(); maislinha3(); somae4(); somaet(); somanfb(); somanft(); if (document.getElementById('equip5').value == ''){}
else{maise4serv(); maislinha(); maislinha3(); somae5(); somaet(); somanfb(); somanft(); if (document.getElementById('equip6').value == ''){}
else{maise5serv(); maislinha(); maislinha3(); somae6(); somaet(); somanfb(); somanft(); if (document.getElementById('equip7').value == ''){}
else{maise6serv(); maislinha(); maislinha3(); somae7(); somaet(); somanfb(); somanft(); if (document.getElementById('equip8').value == ''){}
else{maise7serv(); maislinha(); maislinha3(); somae8(); somaet(); somanfb(); somanft(); if (document.getElementById('equip9').value == ''){}
else{maise8serv(); maislinha(); maislinha3(); somae9(); somaet(); somanfb(); somanft(); if (document.getElementById('equip10').value == ''){}
else{maise9serv(); maislinha(); maislinha3(); somae10(); somaet(); somanfb(); somanft(); if (document.getElementById('equip11').value == ''){}
else{maise10serv(); maislinha(); maislinha3(); somae11(); somaet(); somanfb(); somanft(); if (document.getElementById('equip12').value == ''){}
else{maise11serv(); maislinha(); maislinha3(); somae12(); somaet(); somanfb(); somanft(); if (document.getElementById('equip13').value == ''){}
else{maise12serv(); maislinha(); maislinha3(); somae13(); somaet(); somanfb(); somanft(); if (document.getElementById('equip14').value == ''){}
else{maise13serv(); maislinha(); maislinha3(); somae14(); somaet(); somanfb(); somanft(); if (document.getElementById('equip15').value == ''){}
else{maise14serv(); maislinha(); maislinha2(); somae15(); somaet(); somanfb(); somanft(); };};};};};};};};};};};};};};};
