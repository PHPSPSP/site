...
$html[$i] = "";
	$html[$i] .= "<table>";
	$html[$i] .= "<tr>";
	$html[$i] .= "<td colspan='4' align='center'><b><font size='+2'>Checklist Higienização de Setores</font></b></td>";
	$html[$i] .= "</tr>";
	$html[$i] .= "</table><br>";
	$html[$i] .= "<table>";
	$html[$i] .= "<tr>";
	$html[$i] .= "<td colspan='4'><b>".$totalreg."</b> Locais Higienizados</td>";
	$html[$i] .= "</tr>";
	$html[$i] .= "</table><br>";
    $html[$i] .= "<table>";
	...
	$html[$i] .= "<td align='center'><b>LOCAL</b></td>";
    $html[$i] .= "</tr>";
    $html[$i] .= "</table>";
}
...
$arquivo = 'Higienizacao_Locais '.$hoje.'.xls';
