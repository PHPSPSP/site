            ...
            <div >
              <div style="width: 100%; margin:0 auto;"><br />
                <div style="width:48%; float:left"> Atividade:<br />
                  ...
                  <input name="dataalt" type="text" id="dataalt"  onblur="check_date(this.value)" onkeypress="formatar(this, '##/##/####'); return SomenteNumero(event)" size="15" maxlength="10" />
                </div>
              ...
              <div >
                <div style="width: 100%; margin:0 auto;"><br />
                  <div style="width:48%; float:left"> <strong>Anterior</strong><br />
                    Escala:<br />
                    <select class="form-control"  name="escalaatual" id="escalaatual">
