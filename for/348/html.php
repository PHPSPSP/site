          ...
          <tbody>
            ...
            <tr>
              <td><table align="center" border="0" cellpadding="0" cellspacing="0" width="628">
                  <tbody>
                    <tr>
                      <td style="color: #d9534f; font-size: 16px; font-family: Helvetica, Arial, sans-serif;">FOR 348 - Alteração Contratual</td>
                    </tr>
                    <tr>
                      <td height="20"></td>
                    </tr>
                    <tr>
                      <td style="color: #666666; font-size: 12px;  font-family: Helvetica, Arial, sans-serif;"> Olá<br>
                        <br>
                       Esse e-mail confirma o envio do FOR 348 referente a <b>Alteração Contratual</b> de serviços de <b><?php echo $post->atividade; ?></b> para a contratante <b><?php echo $post->razaosocial; ?></b>, verifique o PDF em anexo!<br>
                        <br>
                        Att.<br>
                  ...
                  <tbody>
                    <tr>
                      <td><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"  style="font-size: 14px; border: 0;">
                          <tbody>
                            <tr>
                              <td align="left" style="color: #fefefe; font-size: 11px; font-family: Helvetica, Verdana, sans-serif; padding: 15px 0;"><? echo "$ver_for_348"; ?></td>
