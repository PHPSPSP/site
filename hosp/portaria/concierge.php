...
<head>
  ...
  <title>Atendimento de Concierge</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="concierge.php"><i class="fa fa-circle-o"></i> Início de Acompanhamento</a></li>
...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><b>Acompanhamento de Pacientes</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Registrar Acompanhamento</p>

    <form action="#" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" style="text-transform:uppercase" name="ap" placeholder="Nome do Paciente">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
       <div class="form-group has-feedback">
        <input type="Nº" class="form-control" style="text-transform:uppercase" name="nomequarto" placeholder="Nº do quarto">
        <span class="glyphicon glyphicon-home form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <span style="text-transform:uppercase">Busca de Pertence </span>
        <input type="checkbox" id="pertence" name="pertence" value="buscar pertence" />
        <span class="glyphicon glyphicon-list-alt form-control-feedback"></span>
      </div>
        <!--botão-->
        <div class="col-xs-4">
          <button type="button" class="btn btn-danger" value="liberar" style="text-transform:uppercase" onclick="direciona('liberar');">Iniciar</button>
        </div>
        <br>
        <div>
