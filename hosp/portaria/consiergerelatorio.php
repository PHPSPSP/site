...
if ($_SESSION['tipo'] != "1" && $_SESSION['tipo'] != "2" && $_SESSION['tipo'] != "3" && $_SESSION['tipo'] != "6" && $_SESSION['tipo'] != "10"){
...
<head>
  ...
  <title>Relatório de Concierge</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="consiergerelatorio.php"><i class="fa fa-circle-o"></i> Relatório de Concierge</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Relatório Concierge</li>
      </ol>
    </section>
  ...
  <div class="register-logo">
    <a href="#"><b>Relatório de Concierge</a>
  </div>
      <!-- /.search form -->
  ...
  <div class="register-box-body">
    ...
    <form action="consiergerelatorio.php" method="POST">
...
<br>
    ...
    <table width="auto" height="40" border="1" align="center" style="text-align: center; text-transform:uppercase; text-align: center;">
      <tr style="background-color: bisque;">
        ...
        <td style="padding: 5px;">Data / Hora Liberado</td>
        <td style="padding: 5px;">Data / Hora Retorno</td>
        <td style="padding: 5px;">Tempo de Acompanhamento</td>
        <td style="padding: 5px;">Busca de Pertences</td>
      </tr>
<?php 
...
if ($data1<"2018-01-01")
  {$sql=mysql_query("select * from spsp1.tb_acopaciente where liberado > DATE_SUB(NOW(), INTERVAL 1 WEEK) order by id ");}
else
  {$sql=mysql_query("select * from spsp1.tb_acopaciente where liberado between '".$data1."' and '".$data2."' order by id ");}

     
      while($consi=mysql_fetch_array($sql))
  
{

$dataretorno2 = date('d/m/Y - H:i:s', strtotime($consi['retornado']));
...
{
$horario1 = date('H:i:s', strtotime($consi['liberado']));
$horario2 = date('H:i:s', strtotime($consi['retornado'])); 
$entrada = $horario1;
$saida = $horario2;
...
$dataretorno = date('d/m/Y - H:i:s', strtotime($consi['retornado']));
}

    echo "
    <tr style='text-transform:uppercase; text-align: center;'> 
               <td style='padding: 5px;'> ".$consi["acopaciente"]."</td>
               <td style='padding: 5px;'> ".$consi["numeroquarto"]."</td>
               <td style='padding: 5px;'> ".date('d/m/Y - H:i:s', strtotime($consi['liberado']))."</td>
               <td style='padding: 5px;'> ".$dataretorno."</td>
               <td style='padding: 5px;'> ".$tempo."</td>
               <td style='padding: 5px;'> ".$consi["pertence"]." - ".$consi["pertence_encontrado"]."</td>
    </tr>
  ";}
 ?>
