...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li   class="active"><a href="alterar_depto.php"><i class="fa fa-circle-o"></i> Alteração de Departamento</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="cracharelsaida.php"><i class="fa fa-circle-o"></i> Relatório de Saida Cracha</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Portaria
        <small>Alterar Departamento</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="../logado.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Portaria Saida</li>
      </ol>
    </section>
    ...
    <section class="content container-fluid">
      ...
      <tr>
        <td width="105" style="font-size: 80%; text-align: center;">Nome Atual</td>
        <td width="97"  style="font-size: 80%; text-align: center;">Novo Nome</td>
        <td width="105" style="font-size: 80%; text-align: center;">Alterar</td>
      </tr>
  <?php 

        //criando a query de consulta à tabela criada
        $sql=mysql_query("select * from spsp1.tb_departamento WHERE local ='".$local."' order by id");
        while($aux=mysql_fetch_array($sql)){

  echo "
    <tr> 
          <form action='alteradepto.php' method='GET'>
               <td> ".$aux["nomes"]."</td>
               <td><input name='novonome' type='text' id='novonome'/></td>
               <td> <input hidden name='id' id='id' value='".$aux["id"]."'><button type='submit' value='libera' class='btn btn-danger'>Alterar Nome</button></td>
          </form>
    </tr>
  "; }
 ?>
