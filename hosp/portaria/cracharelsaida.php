...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg">Controle de Acesso</span>
    </a>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="consiergerelatorio.php"><i class="fa fa-circle-o"></i> Relatório Concierge</a></li>
            <li class="active"><a href="cracharelsaida.php"><i class="fa fa-circle-o"></i> Relatório de Saida Cracha</a></li>
            <li><a href="cracharelretorno.php"><i class="fa fa-circle-o"></i> Relatório de Retorno Cracha</a></li>
            <li><a href="relatorioentrada.php"><i class="fa fa-circle-o"></i> Relatório Portaria Entrada</a></li>
            <li><a href="relatoriosaida.php"><i class="fa fa-circle-o"></i> Relatório Portaria Saida</a></li>
          </ul>
      </ul>
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Retorno Cracha</li>
      </ol>
    </section>
  ...
  <!-- search form -->
      ...
      <!--Formulario -->
        <table width="auto" height="40" border="1" align="center"  style="text-align: center;">
      <tr>
        <td width="105" style="font-size: 80%; text-align: center;">Nome</td>
        <td width="97"  style="font-size: 80%; text-align: center;">Nº do Cracha</td>
        <td width="105" style="font-size: 80%; text-align: center;">Local</td>
        <td width="105" style="font-size: 80%; text-align: center;">Data Saida</td>
        <td width="105" style="font-size: 80%; text-align: center;">Hora Saida</td>
      </tr>
<?php 

        //criando a query de consulta à tabela criada
        $sql=mysql_query("select * from spsp1.tb_saidacracha order by id");
        while($buscacrachas=mysql_fetch_array($sql))
  echo "
    <tr> 
          <form action='#' method='GET'>
               <td> ".$buscacrachas["nome"]."</td>
               <td> ".$buscacrachas["numerodocracha"]."</td>
               <td> ".$buscacrachas["local"]."</td>
               <td> ".date('d/m/Y', strtotime($buscacrachas['saicracha']))."</td>
               <td> ".date('H:i:s', strtotime($buscacrachas['saicracha']))."</td>
               <input hidden name='id' id='id' value='".$buscacrachas["id"]."'>
          </form>
    </tr>
  ";
 ?>
