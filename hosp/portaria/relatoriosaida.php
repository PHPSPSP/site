...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="relatoriosaida.php"><i class="fa fa-circle-o"></i> Relatório Portaria Saida</a></li>
          </ul>
      </ul>
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Relatório 
        <small>de Saida</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Inicio</a></li>
        <li class="active">Relatório Saida</li>
      </ol>
    </section>
   ...
   <div class="container">
    ...
    <!--Formulario -->
      ...
      <tr>
        ...
        <td width="105" style="font-size: 80%; text-align: center;">Horario Saida</td>

  <?php 

          //criando a query de consulta à tabela criada
          $sql=mysql_query("select * from tb_entrada WHERE status= 'liberado' order by id");
