...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Alterar Departamento</li>
      </ol>
    </section>
  ...
  <div class="register-logo">
    <a href="#"><b>Alteração de Departamento</a>
  </div>
      <!-- /.search form -->
      ...
      <tr style="background-color: bisque;">
        <td  style="padding: 5px;">Nome Atual</td>
        <td  style="padding: 5px;">Novo Nome</td>
        <td  style="padding: 5px;">Alterar</td>
        <td  style="padding: 5px;">Deletar</td>
      </tr>
  <?php 

        //criando a query de consulta à tabela criada
        $sql=mysql_query("select * from spsp1.tb_departamento WHERE local ='".$local."' order by nomes");
        while($aux=mysql_fetch_array($sql)){

  echo "
    <tr style='text-transform:uppercase; text-align: center;'> 
          <form action='alteradepto.php' method='GET'>
               <td style='padding: 5px;'> ".$aux["nomes"]."</td>
               <td style='padding: 5px;'><input name='novonome' style='text-transform:uppercase;' type='text' id='novonome'/></td>
               <td style='padding: 5px;'><input hidden name='id' id='id' value='".$aux["id"]."'>
                                         <button type='submit' value='libera' class='btn btn-danger'>Alterar Nome</button></form></td>
               <form action='deletardepto.php' method='GET'><td style='padding: 5px;'>
                                         <input hidden name='id' id='id' value='".$aux["id"]."'>
                                         <button type='submit' value='libera' class='btn btn-danger'>Deletar Departamento</button></td>
          </form>
    </tr>
  "; }
 ?>
