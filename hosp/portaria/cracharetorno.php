...
<head>
  ...
  <title>Devolução de Crachá</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="cracharetorno.php"><i class="fa fa-circle-o"></i> Retorno de Cracha</a></li>
          </ul>
        </li>
        <?php if ($_SESSION['tipo']=='1' || $_SESSION['tipo']=='2' || $_SESSION['tipo']=='3' || $_SESSION['tipo']=='6' || $_SESSION['tipo']=='10') { ?>
          <li class="treeview">
  ...
  <div class="register-logo">
    <a href="#"><b>Devolução de Crachá</a>
  </div>
      <!-- /.search form -->
      ...
      <tr style="background-color: bisque;">
        ...
        <td style="padding: 5px;">Data Saida</td>
        <td style="padding: 5px;">Hora Saida</td>
        <td style="padding: 5px;">Retorno</td>
      </tr>
<?php 

        //criando a query de consulta à tabela criada
        $sql=mysql_query("select * from spsp1.tb_saidacracha WHERE status =' ' order by id");
        while($aux=mysql_fetch_array($sql)){
  echo "
    <tr style='text-transform:uppercase; text-align: center;'> 
          <form action='gravaretorno.php' method='GET'>
               <td style='padding: 5px;'> ".$aux["nome"]."</td>
               <td style='padding: 5px;'> ".$aux["numerodocracha"]."</td>
               <td style='padding: 5px;'> ".$aux["local"]."</td>
               <td style='padding: 5px;'> ".date('d/m/Y', strtotime($aux['saicracha']))."</td>
               <td style='padding: 5px;'> ".date('H:i:s', strtotime($aux['saicracha']))."</td>
               <td style='padding: 5px;'> <input hidden name='id' id='id' value='".$aux["id"]."'><button type='submit' value='libera' class='btn btn-danger'>Devolver Crachá</button></td>
          </form>
    </tr>
  "; }
 ?>
