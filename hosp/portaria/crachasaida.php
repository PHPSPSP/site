...
<head>
  ...
  <title>Retenção de Crachá</title>
    ...
    <section class="sidebar">
     ...
     <li class="treeview">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="crachasaida.php"><i class="fa fa-circle-o"></i> Saida de Cracha</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Saida Cracha</li>
      </ol>
    </section>
...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><b>Registro de Crachá de Acompanhante</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Liberar saida de acompanhante</p>

    <form action="gravasaida.php" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="nome" style="text-transform:uppercase" placeholder="Nome">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="ndocracha" onkeypress="return somenteNumeros(event)" style="text-transform:uppercase" placeholder="Nº do cracha">
        <span class="glyphicon glyphicon-list-alt form-control-feedback"></span>
      </div>
       <div class="form-group has-feedback">
        <input type="text" class="form-control" name="local" style="text-transform:uppercase" placeholder="Local">
        <span class="glyphicon glyphicon-home form-control-feedback"></span>
      <BR>
        <!--botão-->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-danger" style="text-transform:uppercase" value="liberar"> Registrar Crachá</button>
        </div>
        <BR>
      </div>
