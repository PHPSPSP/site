...
<head>
  ...
  <title>Relatório de Crachás</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="cracharelretorno.php"><i class="fa fa-circle-o"></i> Relatório de Crachá</a></li>
          </ul></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Relatório de Crachá</li>
      </ol>
    </section>
  ...
  <div class="register-logo">
    <a href="#"><b>Relatório de Crachá</a>
  </div>
      <!-- /.search form -->
  ...
  <div class="register-box-body">
    ...
    <form action="cracharelretorno.php" method="POST">
...
<br>
      ...
      <tr style="background-color: bisque;">
        ...
        <td style="padding: 5px;">Nº do Cracha</td>
...
if ($data1<"2018-01-01")
  {$sql=mysql_query("select * from spsp1.tb_saidacracha where saicracha > DATE_SUB(NOW(), INTERVAL 1 WEEK) order by id ");}
else
  {$sql=mysql_query("select * from spsp1.tb_saidacracha where saicracha between '".$data1."' and '".$data2."' order by id ");}

    //criando a query de consulta à tabela criada
      while($buscacrachar=mysql_fetch_array($sql)){

$dataretorno2 = date('d/m/Y - H:i:s', strtotime($buscacrachar['retornocracha']));
...
{
$dataretorno = date('d/m/Y - H:i:s', strtotime($buscacrachar['retornocracha']));
}

    echo "
     <tr style='text-transform:uppercase; text-align: center;'> 
               <td style='padding: 5px;'> ".$buscacrachar["nome"]."</td>
               <td style='padding: 5px;'> ".$buscacrachar["numerodocracha"]."</td>
               <td style='padding: 5px;'> ".$buscacrachar["local"]."</td>
               <td style='padding: 5px;'> ".date('d/m/Y - H:i:s', strtotime($buscacrachar['saicracha']))."</td>
