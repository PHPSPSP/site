...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="cadastro_depto.php"><i class="fa fa-circle-o"></i> Cadastro de Departamento</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Portaria
        <small>Cadastro de Departamento</small>
      </h1>
      <ol class="breadcrumb">
...
<div class="register-box">
  <div class="register-logo">
    <a href="#"><b>Cadastro de Departamento</a>
  </div>

  <div class="register-box-body">
    <p class="login-box-msg">Cadastro novo departamento</p>

    <form action="gravardepto.php" method="POST">
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="nome" required="" style="text-transform:uppercase" placeholder="Nome do Departamento">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
       <div class="form-group has-feedback">
        <!--botão "gravar acesso"...ao clicar é para gravar a hora/data de entrada no banco de dados-->
        <div class="col-xs-4">
          <button type="submit" class="btn btn-danger" style="text-transform:uppercase" value="gravar"> Cadastrar</button>
        </div>
