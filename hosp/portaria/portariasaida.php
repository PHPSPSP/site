...
<head>
  ...
  <title>Lebração da Portaria</title>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li  class="active"><a href="portariasaida.php"><i class="fa fa-circle-o"></i> Portaria Saida</a></li>
  ...
  <div class="register-logo">
    <a href="#"><b>Registro de Saída</a>
      ...
      <tr style="background-color: bisque;">
        ...
        <td style='padding: 5px;'>Placa do veiculo</td>
        <td style='padding: 5px;'>Tipo do veiculo</td>
        <td style='padding: 5px;'>Departamento</td>
        <td style='padding: 5px;'>Data Entrada</td>
        <td style='padding: 5px;'>Horario Entrada</td>
        <td style='padding: 5px;'>Paciente / Quarto</td>
        <td style='padding: 5px;'>Liberar</td>
      </tr>
  <?php 

        //criando a query de consulta à tabela criada
        $sql=mysql_query("select * from spsp1.tb_entrada WHERE status =' ' order by id");
        while($aux=mysql_fetch_array($sql)){

$sql2=mysql_query("SELECT * FROM tb_departamento where id='".$aux["departamento"]."'");  
while($nomelocal = mysql_fetch_array($sql2)) $departamento2 = $nomelocal['nomes'];
  ...
  echo "
    <tr style='text-transform:uppercase; text-align: center;'> 
          <form action='liberaracesso.php' method='GET'>
               ...
               <td style='padding: 5px;'> ".$departamento2."</td>
               <td style='padding: 5px;'> ".date('d/m/Y', strtotime($aux['horaentrada']))."</td>
               <td style='padding: 5px;'> ".date('H:i:s', strtotime($aux['horaentrada']))."</td>
               <td style='padding: 5px;'> ".$aux["nomepaciente"]." </td>
               <td style='padding: 5px;'> <input hidden name='id' id='id' value='".$aux["id"]."'><button type='submit' value='libera' class='btn btn-danger'>Liberar Saída</button></td>
          </form>
    </tr>
  "; }
 ?>
