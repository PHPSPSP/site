        ...
        <tr>
          <td style="color: #666666; font-family: Helvetica, Arial, sans-serif;"><strong>Dados da Vistoria Limpeza  <? echo "$tipolimpeza"; ?>:</strong><br>
            ...
            <table style="color: #666666; font-size: 8px;  font-family: Helvetica, Arial, sans-serif;" width="100%" bordercolor="#CCCCCC" border="1" cellspacing="0" cellpadding="0">
              <tr>
                <td bgcolor="#E5E5E5" width="20%" height="15" align="center" valign="middle">Itens</td>
                <td bgcolor="#E5E5E5" width="10%" height="15" align="center" valign="middle">Limpeza</td>
                <td bgcolor="#E5E5E5" width="40%" height="15" align="center" valign="middle">OBS</td>
                <td bgcolor="#E5E5E5" width="30%" height="15" align="center" valign="middle">Abertura de OS</td>
              </tr>
              <tr>
