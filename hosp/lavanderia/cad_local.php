...
if($cnt <= 0){
  ...
  $a=mysql_query("INSERT INTO lavanderia_local (lavanderia_nome_local, lavanderia_cliente_local, lavanderia_status_local) VALUES('$n', '$clienteativo', '0')");
  if($a){
    ...
    foreach ($controle as $c) {
      mysql_query("INSERT INTO lavanderia_controle (lavanderia_local, lavanderia_enxoval, contagem_padrao, lavanderia_cliente, data_hora) VALUES('$id', '" . $c["enxoval"] ."', '" . $c["contagem"] . "', '$clienteativo', '".$date."')");
    }

    foreach ($controle2 as $e) {
      mysql_query("INSERT INTO lavanderia_extra (lavanderia_local, lavanderia_enxoval, lavanderia_cliente, data_hora) VALUES('$id', '" . $e["extra"] ."', '$clienteativo', '".$date."')");
    }
