        ...
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              ...
              CPF não encontrado, por favor <strong>tente novamente</strong> ou entre em contato com a <a href="mailto:gustavo.guedes@spsp.com.br"><strong>SPSP</strong></a>.<br><br>
              <a class="btn btn-lg btn-danger" href="spsp-cadastro-curso-portaria.php" role="button">Tentar Novamente</a></div>
            </div>
          </div>
        </div>
      </div>
