...
<div id="content">
        ...
        <div class="row">
          <div class="col-md-12">
            <header class="text-center element-normal-top element-medium-bottom not-condensed os-animation" data-os-animation="fadeInUp" data-os-animation-delay="0s">
              ...
              <h1 class="super hairline bordered bordered-normal">Curso de Formação de Agente de Portaria</h1>
            </header>
          </div>
        </div>
        <div class="row">
 ...
 <font size="+2" color="#FF0000"> <strong><a href="spsp-cadastro-curso-portaria.php">CLIQUE AQUI E FAÇA SUA INSCRIÇÃO!!!</a></strong></font>
...
<img src="../../assets/images/uploads/spsp-curso-portaria.jpg" />
