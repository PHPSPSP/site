...
<title>Grupo SPSP - Curso de Agente de Portaria</title>
...
<div id="content">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <header class="text-center element-short-top element-short-bottom not-condensed "  >
          <h1 class="super hairline bordered bordered-normal">&nbsp; </h1>
          <h1 class="super hairline bordered bordered-normal"> Acesso Negado! </h1>
        </header>
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              ...
              <img src="../assets/images/icons/danger-512.png" width="150" /> <br />
              Usuário ou senha incorreta, por favor <strong>tente novamente</strong> ou entre em contato com o <a href="mailto:gustavo.guedes@spsp.com.br"><strong>Departamento de Marketing</strong></a>.<br><br>
              <a class="btn btn-lg btn-danger" href="index.php" role="button">Tentar Novamente</a></div>
            </div>
          </div>
        </div>
      </div>
