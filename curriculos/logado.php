...
<a href="#group_1" class="accordion-toggle collapsed" data-toggle="collapse"><i class="fa fa-calendar" style="font-size:50px; color:#FFF"></i><br>Currículos Cadastrados</a>
</div>
<div id="group_1" class="panel-collapse collapse ">
<div class="panel-body">
<div class=" element-no-top element-no-bottom text-left" data-="none" >
<a href="relatorio.php">Busca de Currículos</a>
</div>
</div>
</div>
</div>
...
<br>
                   ...
                   <?php if ($_SESSION['tipo']=='adm' || $_SESSION['tipo']=='rh') { ?>

                   <div class="col-md-4  col-sm-6 col-xs-6 text-center small-screen-center "  >
<div class="btn-group" role="group">                
<div class="panel panel-default">
<div class="panel-heading">
<a href="#group_2" class="accordion-toggle collapsed" data-toggle="collapse"><i class="fa fa-edit" style="font-size:50px; color:#FFF"></i><br>Cadastro de Vagas</a>
</div>
<div id="group_2" class="panel-collapse collapse ">
<div class="panel-body">
<div class=" element-no-top element-no-bottom text-left" data-="none" >
<a href="cadvagas.php">Cadastrar Vagas</a><br><hr color="#FFFFFF" style="margin:0">
<a href="excvagas.php">Excluir Vagas</a>
</div>
</div>
</div>
</div>
