	...
	<nav class="collapse navbar-collapse main-navbar" role="navigation">
      <ul id="menu-one-page" class="nav navbar-nav navbar-right">
       <li><a target="_self" href="logado.php">Início</a></li>
        ...
        <?php if ($_SESSION['tipo']=='adm') { ?><li><a target="_self" href="reg.php">Painel Administrador</a></li><?php } ?>
  ...
  <article>
    <section id="two" class="section swatch-white">
      <div class="container" style="padding-bottom: 180px;">
        <div class="row">
          <div class="col-md-12">
            <header class="text-center element-normal-top element-medium-bottom not-condensed " data-="fadeInUp" data--delay="0s">
...
<div class="col-md-6  col-sm-6 col-xs-12 text-left small-screen-center " >
    ...
    <input class="form-control" type="button" value="Voltar" onclick="location.href='logado.php'"/> 
      ...
      <div class="row">
        ...
        <div class="col-md-12 ">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12" style="text-align:center; line-height:1 !important"> <br>
              ...
              Todos os direitos reservados - Marília/SP - 2018
              </div></div></div>
          </header>
        </div>
      </div>
