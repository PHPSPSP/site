...
$sql = mysql_query("SELECT * FROM user WHERE login='$l' OR mail='$m'");
$cnt = @mysql_num_rows($sql);
if($cnt <= 0){
  $s = md5(md5(md5(md5($_POST['s']))));
  
  $a=mysql_query("INSERT INTO user(nome, mail, login, tipo, senha, senha2) VALUES('$_POST[n]', '$_POST[m]', '$_POST[l]', '$_POST[t]', '$s', '$_POST[s]')");
